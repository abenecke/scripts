...
void weight_hist(){
 ...
 // ////////////                     Set Name of these Histogramms                  /////////////////////////////////////

 //  new_MU24_eta_ratio->SetDirectory("IsoMu24_OR_IsoTkMu24_EtaBins");
 ...
 ////////////                    Save new histogramms in new file                /////////////////////////////////////
  ...
  //Trigger Mu 50
  TDirectory *dir4 =trigger_allRuns ->mkdir("IsoMu50_OR_IsoTkMu50_EtaBins");
  dir4->cd();
  new_MU50_eta_ratio->Write(); 

  TDirectory *dir5 =trigger_allRuns ->mkdir("IsoMu50_OR_IsoTkMu50_PtEtaBins");
  dir5->cd();
  new_MU50_abseta_pt_ratio ->Write(); 
  new_MU50_pt_abseta_ratio ->Write(); 

  TDirectory *dir6 =trigger_allRuns ->mkdir("IsoMu50_OR_IsoTkMu50_PtBins");
  dir6->cd();
