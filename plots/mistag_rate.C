...
//TString unc_folder = "/nfs/dust/cms/user/abenecke/ZPrimeTotTPrime/25ns/rootfile/QCD/mass/hists/higgs/";
//TString unc_folder = "/nfs/dust/cms/user/abenecke/ZPrimeTotTPrime/25ns/rootfile/eff/test";
...
TGraphAsymmErrors* get_eff(TString sample, TString obs, TString hname1,double &tot_eff, double &tot_err,TString hname_all,TString hname_trig )
{
  ...
  if (sample.CompareTo("data", TString::kIgnoreCase) == 0){
    //    file = new TFile("/nfs/dust/cms/user/abenecke/ZPrimeTotTPrime/25ns/rootfile/QCD/uhh2.AnalysisModuleRunner.DATA.Data.root", "READ");
    ...
    //file = new TFile("/nfs/dust/cms/user/abenecke/ZPrimeTotTPrime/25ns/rootfile/QCD/uhh2.AnalysisModuleRunner.MC.QCD.root", "READ");
