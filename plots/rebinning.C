...
void rebinning()
{
  TString directory = "/nfs/dust/cms/user/abenecke/ZPrimeTotTPrime/25ns/rootfile/divided/";
  TFile * infile1 = new TFile(directory+"/uhh2.AnalysisModuleRunner.MC.MC_ZPrime1500ToTPrime1200T_TPrimeToZT.root");
  TFile * infile2 = new TFile(directory+"/uhh2.AnalysisModuleRunner.MC.MC_ZPrime2000ToTPrime1200T_TPrimeToZT.root");
  TFile * infile3 = new TFile(directory+"/uhh2.AnalysisModuleRunner.MC.MC_ZPrime2500ToTPrime1200T_TPrimeToZT.root");
 ...
 // TString hist = "zw_notop_chi2min_chi2cut/M_ZPrime_rec";
  ...
  TString hist = "muon_twodcut/pt_1";
...
//  }
  ...
  TFile *f1= new TFile(directory + "/test/uhh2.AnalysisModuleRunner.MC.MC_ZPrime1500ToTPrime1200T_TPrimeToZT.root","RECREATE");
  M_higgsnotop1 ->Write();
  f1->Close();
  
  TFile *f2= new TFile(directory + "/test/uhh2.AnalysisModuleRunner.MC.MC_ZPrime2000ToTPrime1200T_TPrimeToZT.root","RECREATE");
  M_higgsnotop2 ->Write();
  f2->Close();
  TFile *f3= new TFile(directory + "/test/uhh2.AnalysisModuleRunner.MC.MC_ZPrime2500ToTPrime1200T_TPrimeToZT.root","RECREATE");
  M_higgsnotop3 ->Write();
  f3->Close();
  ...
  TFile *f4= new TFile(directory + "/test/uhh2.AnalysisModuleRunner.MC.other.root","RECREATE");
  other ->Write();
  f4->Close();
  TFile *f5= new TFile(directory + "/test/uhh2.AnalysisModuleRunner.MC.TTbar.root","RECREATE");
  ttbar ->Write();
  f5->Close();
  
  TFile *f6= new TFile(directory + "/uhh2.AnalysisModuleRunner.MC.WJets.root","RECREATE");
  wjets ->Write();
  f6->Close();
  
  TFile *f7= new TFile(directory + "/test/uhh2.AnalysisModuleRunner.Data.Data.root","RECREATE");
  data ->Write();
  f7->Close();
