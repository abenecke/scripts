...
//count events in background histogram
  ...
  // Double_t error_mistagrate_data_up= 0.038;
  // Double_t error_mistagrate_data_down= 0.016;
  // Double_t mistag_rate_MC=number_back/number_back_MC_miss;
  // Double_t mistag_rate_data=mistag_rate_MC * corr_mistagrate;
  // Double_t error_mistagrate_MC_up=TMath::Sqrt(TMath::Power((1/number_back_MC_miss)*error_back,2) + TMath::Power((number_back/number_back_MC_miss/number_back_MC_miss)*,2) );
  // Double_t error_mistagrate_MC_down=0.0021;
 ...
 //Par7
  ...
  Double_t corr_mistagrate = 1.067;
  Double_t error_corr_mistagrate_up = TMath::Sqrt(TMath::Power(0.00935,2) + TMath::Power(0,2));
  Double_t error_corr_mistagrate_down = TMath::Sqrt(TMath::Power(0.00935,2) + TMath::Power(0,2));
  Double_t mistag_rate_MC = number_back/number_back_MC_miss;
  Double_t mistag_rate_data = mistag_rate_MC * corr_mistagrate;
 ...
 /****************************/
  ...
  //define Line of the up and down variation in chi2
  TLine* l_pars_dn_Data[6];
  TLine* l_pars_up_Data[6];
  TLine* l_pars_central_Data[6];
  for(int i=0; i<6; i++){
  ...
  c_chi2_p0_Data->Print("Chi2_Data_p1.eps");
 ...
 //Par7
  ...
  myfile << "----------------------------------------------------------------------------------------------------------"<<endl;
  myfile << "                                             Final result            (bei after fehlt der Fehler auf die misstagrate)                                     "<<endl;
  myfile << "----------------------------------------------------------------------------------------------------------"<<endl;
