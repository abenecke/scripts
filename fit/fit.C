...
void fit()
{
  ...
  TString folder ="erf/old_mistagrate_";
  ...
  TString directory = "/nfs/dust/cms/user/abenecke/ZPrimeTotTPrime/CMSSW_8X/rootfiles/efficiency_topjetcollection/"+unc_name;
  TString bkgfolder = "";
  ...
  TFile * TTbar_matched_dr04_f = new TFile("/nfs/dust/cms/user/abenecke/ZPrimeTotTPrime/CMSSW_8X/rootfiles/eff_Dr04/uhh2.AnalysisModuleRunner.MC.TTbar_right.root", "READ");
  TFile * TTbar_unmatched_dr12_f = new TFile("/nfs/dust/cms/user/abenecke/ZPrimeTotTPrime/CMSSW_8X/rootfiles/eff_Dr12/uhh2.AnalysisModuleRunner.MC.TTbar_wrong.root", "READ");
  ...
  TH1F* TTbar_matched_dr04 = (TH1F*)TTbar_matched_dr04_f->Get(hist_name);
  TH1F* TTbar_unmatched_dr12 = (TH1F*)TTbar_unmatched_dr12_f->Get(hist_name);
  ...
  TF1* bkg = new TF1("bkg", "[0]*(1.-TMath::Power(1+TMath::Exp(-(x-[1])/[2]),-1.)) ", 40, 180);  
  bkg->SetParameter(0, 110);
  bkg->SetParameter(1, 101);
  bkg->SetParameter(2, 15);

  TF1* sig = new TF1("sig", "TMath::Voigt(x-([2]+[4]*x), [0]+[5]*x, [1], 4)*[3]", 40, 180);
  sig->SetParameter(0, 0.42);
  sig->FixParameter(1, 2.09);
  sig->SetParameter(2, 15.24);
  sig->SetParameter(3, 693);
  sig->SetParameter(4, 0.83);
  sig->SetParameter(5, 0.012);

  TF1* background_fit = new TF1("background_fit", "bkg+sig", 40, 180);
  background_fit->SetParameter(0, bkg->GetParameter(0));
  background_fit->SetParameter(1, bkg->GetParameter(1));
  background_fit->SetParameter(2, bkg->GetParameter(2));

  // signal component: fix all parameters except for normalisation
  background_fit->FixParameter(3, sig->GetParameter(0));
  background_fit->FixParameter(4, sig->GetParameter(1));
  background_fit->FixParameter(5, sig->GetParameter(2));
  background_fit->SetParameter(6, 0.2*sig->GetParameter(3));
  background_fit->FixParameter(7, sig->GetParameter(4));
  background_fit->FixParameter(8, sig->GetParameter(5));
  background_fit->SetParLimits(6, 0., 1000.);
  ...
  bkg->SetParameter(0,background_fit->GetParameter(0));
  bkg->SetParameter(1,background_fit->GetParameter(1));
  bkg->SetParameter(2,background_fit->GetParameter(2));    
  bkg->SetLineColor(kOrange+1);
  bkg->SetLineWidth(3);  
  bkg->SetLineStyle(kDashed);
  bkg->DrawClone("same");  

  sig->SetParameter(0,background_fit->GetParameter(3));
  sig->SetParameter(1,background_fit->GetParameter(4));
  sig->SetParameter(2,background_fit->GetParameter(5));    
  sig->SetParameter(3,background_fit->GetParameter(6));      
  sig->SetParameter(4,background_fit->GetParameter(7));    
  sig->SetParameter(5,background_fit->GetParameter(8));      
  sig->SetLineColor(kGreen+1);
  sig->SetLineWidth(3);    
  sig->SetLineStyle(kDashed);
  sig->DrawClone("same"); 

  TString info = "unmatched t#bar{t} events";
  TString info2 = "40 GeV < m_{W} < 180 GeV";
  TString info3 = "bkg(x) = p0*(1-1/(1+e^{-x'}))";
  TString info4 = "x' = (x-p1)/p2";
 ...
 TLatex* text2 = new TLatex();
  ...
  //Number of signal events in background histogram
  TF1 *Sig_in_bkg_f =new TF1("Sig_in_bkg_f","sig", 40,180);
  //signal
  Sig_in_bkg_f->SetParameter(0, background_fit->GetParameter(3));
  Sig_in_bkg_f->SetParameter(1, background_fit->GetParameter(4));
  Sig_in_bkg_f->SetParameter(2, background_fit->GetParameter(5));
  Sig_in_bkg_f->SetParameter(3, background_fit->GetParameter(6));
  Sig_in_bkg_f->SetParameter(4, background_fit->GetParameter(7));
  Sig_in_bkg_f->SetParameter(5, background_fit->GetParameter(8));
  Double_t num_sig_in_bkg_before = Sig_in_bkg_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  ...
  TCanvas *signal_c = new TCanvas("signal_c","signal fit",10,10,700,700);
  gPad->SetTickx();
  gPad->SetTicky();
  signal_c->Clear();
  signal_c->cd();
  ...
  //Hier
  // Double_t count_error_sig;
  // Double_t count_num_MC_before =TTbar_matched->IntegralAndError(13,92,count_error_sig);


  /////////////////////////   Fit function (Signal)  ////////////////////////
  TF1 *signal_fit = new TF1("signal_fit","sig", 50, 140); //modified 
  signal_fit->SetParameter(0, 0.42);
  signal_fit->FixParameter(1, 2.09);
  signal_fit->SetParameter(2, 15.24);
  signal_fit->SetParameter(3, 693);
  signal_fit->SetParameter(4, 0.83);
  signal_fit->SetParameter(5, 0.012);
  ...
  // ------------------------
  TCanvas *signal_background_c = new TCanvas("signal_background_c","signal+background fit",10,10,700,700);
  gPad->SetTickx();
  gPad->SetTicky();
  ...
  TF1 *signal_background_fit = new TF1("signal_background_fit","sig + bkg", 40,180);
  ...
  signal_background_fit->SetParameter(4, signal_fit->GetParameter(4));
  signal_background_fit->SetParameter(5, signal_fit->GetParameter(5));  
  //Background
  signal_background_fit->SetParameter(6, background_fit->GetParameter(0));
  signal_background_fit->SetParameter(7, background_fit->GetParameter(1));
  signal_background_fit->SetParameter(8, background_fit->GetParameter(2));
  ...
  bc->SetParameter(0, signal_background_fit->GetParameter(6));
  bc->SetParameter(1, signal_background_fit->GetParameter(7));  
  bc->SetParameter(2, signal_background_fit->GetParameter(8));  
  ...
  TCanvas *data_c = new TCanvas("data_c","data",10,10,700,700);
  gPad->SetTickx();
  gPad->SetTicky();
  data_c->Clear();
  data_c->cd();
  ...
  /////////////////////////   Fit function (Data)  ////////////////////////
  TF1* data_fit = new TF1("data_fit","signal_background_fit" ,40,180);
  ...
  data_fit->SetParameter(4, signal_background_fit->GetParameter(4));
  data_fit->SetParameter(5, signal_background_fit->GetParameter(5)); 
  //background
  data_fit->SetParameter(6, sc*signal_background_fit->GetParameter(6));   
  data_fit->SetParameter(7, sc*signal_background_fit->GetParameter(7));
  data_fit->SetParameter(8, sc*signal_background_fit->GetParameter(8));
  ...
  bc->SetParameter(0, data_fit->GetParameter(6));
  bc->SetParameter(1, data_fit->GetParameter(7)); 
  bc->SetParameter(2, data_fit->GetParameter(8)); 
  ...
  //        Calculate Efficency
  // ---------------------------------------
  TCanvas *MC_Eff_c = new TCanvas("MC_Eff_c","MC Eff curve",10,10,700,700);
  gPad->SetTickx();
  gPad->SetTicky();
  MC_Eff_c->Clear();
  MC_Eff_c->cd();

  TF1 *MC_Eff_f =new TF1("MC_Eff_f","signal_fit", 40,180);
   //signal
  ...
  TF1 *data_Eff_f =new TF1("data_Eff_f","signal_fit", 40,180);
  //signal
  ...
  Double_t num_MC_before = MC_Eff_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number before tagger:   "<< num_MC_before <<endl;
  Double_t num_data_before = data_Eff_f->Integral(40,180,TMath::Power(10,-8))/2;
  ...
  TF1 *MC_back_f =new TF1("MC_back_f","bkg", 40,180);
  //background
  MC_back_f->SetParameter(0, signal_background_fit->GetParameter(6));
  MC_back_f->SetParameter(1, signal_background_fit->GetParameter(7));
  MC_back_f->SetParameter(2, signal_background_fit->GetParameter(8));
  Double_t number_back_MC_miss = MC_back_f->Integral(40,180) / 2;
  ...
  TF1 *data_back_f =new TF1("data_back_f","bkg", 40,180);
  //background
  data_back_f->SetParameter(0, data_fit->GetParameter(6));
  data_back_f->SetParameter(1, data_fit->GetParameter(7));
  data_back_f->SetParameter(2, data_fit->GetParameter(8));

  Double_t number_back_data_miss = data_back_f->Integral(40,180) / 2;
  cout << "number back_data_miss "<<number_back_data_miss <<endl;
  data_back_f->SetLineColor(kBlue+1);
  data_back_f->SetLineStyle(kDashed);
  data_back_f->Draw("");
  MC_back_f->Draw("Same");
...
//count events in signal histogram
  ...
  std::cout<<"BinCenter TTBar_matched number_sig_before_ hist 0.8  "<<TTbar_matched->GetBinCenter(20)<<std::endl;;
  std::cout<<"BinCenter TTBar_matched number_sig_before_ hist 0.8  "<<TTbar_matched->GetBinCenter(90)<<std::endl;;
...
//count events in background histogram
  ...
  myfile << "Hist(0.8) number of MC sig before tagger   "<< number_sig_before_true<<endl;
  myfile<<"Data number before tagger (sig):   "<< num_data_before <<endl;
  myfile << "MC number before tagger (bkg):   "<< number_back_MC_miss <<endl;
  myfile << "Hist(0.8) MC number before tagger (bkg):   "<< number_bkg_before_true <<endl;
  ...
  const double h_MC = fit_all_result->Parameter(7);
  const double i_MC = fit_all_result->Parameter(8);
  const double old_params_MC[9] = {a_MC,b_MC,c_MC,d_MC,e_MC,f_MC,g_MC,h_MC,i_MC};
  const TVectorD V_Old_Param_MC(9,old_params_MC);
 ...
 /****************************/
  ...
  double a_tr_MC[9], b_tr_MC[9], c_tr_MC[9], d_tr_MC[9], e_tr_MC[9], f_tr_MC[9], g_tr_MC[9], h_tr_MC[9], i_tr_MC[9];
  for (int i=0; i<9; i++){
    ...
    h_tr_MC[i] = TMatrixDRow(M_Dummy_MC,7)[i];
    i_tr_MC[i] = TMatrixDRow(M_Dummy_MC,8)[i];
  }

  //string of new fit function with uncorrelated parameters
  // stringstream sstr_MC;
  stringstream sstr_MC;
  sstr_MC << "((" <<d_tr_MC[0]<<"*[0]+" <<d_tr_MC[1]<<"*[1]+" <<d_tr_MC[2]<<"*[2]+" <<d_tr_MC[3]<<"*[3]+" <<d_tr_MC[4]<<"*[4]+" <<d_tr_MC[5]<<"*[5]+" <<d_tr_MC[6]<<"*[6]+" <<d_tr_MC[7]<<"*[7]+" <<d_tr_MC[8]<<"*[8]" << ")* TMath::Voigt(x-(""("<<  c_tr_MC[0] << "*[0]+" <<  c_tr_MC[1] << "*[1]+"<<  c_tr_MC[2] << "*[2]+"<<  c_tr_MC[3] << "*[3]+"<<  c_tr_MC[4] << "*[4]+"<<  c_tr_MC[5] << "*[5]+"<<  c_tr_MC[6] << "*[6]+"<<  c_tr_MC[7] << "*[7]+"<<  c_tr_MC[8] << "*[8]"<<")+("<< e_tr_MC[0] << "*[0]+" <<  e_tr_MC[1] << "*[1]+"<<  e_tr_MC[2] << "*[2]+"<<  e_tr_MC[3] << "*[3]+"<<  e_tr_MC[4] << "*[4]+"<<  e_tr_MC[5] << "*[5]+"<<  e_tr_MC[6] << "*[6]+"<<  e_tr_MC[7] << "*[7]+"<<  e_tr_MC[8] << "*[8]" <<")*x),("<<"("<<  a_tr_MC[0] << "*[0]+" <<  a_tr_MC[1] << "*[1]+"<<  a_tr_MC[2] << "*[2]+"<<  a_tr_MC[3] << "*[3]+"<<  a_tr_MC[4] << "*[4]+"<<  a_tr_MC[5] << "*[5]+"<<  a_tr_MC[6] << "*[6]+"<<  a_tr_MC[7] << "*[7]+"<<  a_tr_MC[8] << "*[8]" <<")+("<< f_tr_MC[0] << "*[0]+" <<  f_tr_MC[1] << "*[1]+"<<  f_tr_MC[2] << "*[2]+"<<  f_tr_MC[3] << "*[3]+"<<  f_tr_MC[4] << "*[4]+"<<  f_tr_MC[5] << "*[5]+"<<  f_tr_MC[6] << "*[6]+"<<  f_tr_MC[7] << "*[7]+"<<  f_tr_MC[8] << "*[8]" <<")*x),("<<  b_tr_MC[0] << "*[0]+" <<  b_tr_MC[1] << "*[1]+"<<  b_tr_MC[2] << "*[2]+"<<  b_tr_MC[3] << "*[3]+"<<  b_tr_MC[4] << "*[4]+"<<  b_tr_MC[5] << "*[5]+"<<  b_tr_MC[6] << "*[6]+"<<  b_tr_MC[7] << "*[7]+"<<  b_tr_MC[8] << "*[8]" <<"),4"<<"))+("<< "(" <<g_tr_MC[0]<<"*[0]+" <<g_tr_MC[1]<<"*[1]+" <<g_tr_MC[2]<<"*[2]+" <<g_tr_MC[3]<<"*[3]+" <<g_tr_MC[4]<<"*[4]+" <<g_tr_MC[5]<<"*[5]+" <<g_tr_MC[6]<<"*[6]+" <<g_tr_MC[7]<<"*[7]+" <<g_tr_MC[8]<<"*[8]" << ")*(1.-TMath::Power(1+TMath::Exp(-(x-("<<  h_tr_MC[0] << "*[0]+" <<  h_tr_MC[1] << "*[1]+"<<  h_tr_MC[2] << "*[2]+"<<  h_tr_MC[3] << "*[3]+"<<  h_tr_MC[4] << "*[4]+"<<  h_tr_MC[5] << "*[5]+"<<  h_tr_MC[6] << "*[6]+"<<  h_tr_MC[7] << "*[7]+"<<  h_tr_MC[8]  <<"))/("<<  i_tr_MC[0] << "*[0]+" <<  i_tr_MC[1] << "*[1]+"<<  i_tr_MC[2] << "*[2]+"<<  i_tr_MC[3] << "*[3]+"<<  i_tr_MC[4] << "*[4]+"<<  i_tr_MC[5] << "*[5]+"<<  i_tr_MC[6] << "*[6]+"<<  i_tr_MC[7] << "*[7]+"<<  i_tr_MC[8] <<")),-1))" <<")";


  //signal: TMath::Voigt(x-([2]+[4]*x), [0]+[5]*x, [1], 4)*[3]
  //background:  [0]*(1.-TMath::Power(1+TMath::Exp(-(x-[1])/[2]),-1.)) 
  ...
  TF1* f_NewParam_MC = new TF1("f_NewParam_MC",c_formula_MC,40,180);
  ...
  f_NewParam_MC->SetParameter(7,V_New_Param_MC[7]);
  f_NewParam_MC->FixParameter(8,V_New_Param_MC[8]);
  ...
  TCanvas* cfitnew_MC = new TCanvas("cfitnewMC", "Fit function in new parameters, MC",10,10,700,700);
  ...
  TF1* f_NewParam_MC_error = new TF1("f_NewParam_MC_error",c_formula_MC,40,180);

  //fix all fit values
  TCanvas* c_dummy_MC = new TCanvas("c_dummy_MC", "Fits for chi2 in MC", 10,10,700,700);
  for(int i=0; i<9; i++){
...
std::cout <<"best chi2 nach dem fit "<<chi2_best_MC<<std::endl;	
  //set up arrays to save the errors 
  double pars_MC[9], pars_up_MC[9], pars_dn_MC[9], err_pars_up_MC[9], err_pars_dn_MC[9];
  for(int i=0; i<9; i++) pars_MC[i] = f_NewParam_MC_error->GetParameter(i);
  bool pars_up_set_MC[9] = {false,false,false,false,false,false,false,false,false};
  bool pars_dn_set_MC[9] = {false,false,false,false,false,false,false,false,false};
  TGraph* g_chi2_pars_MC[9];
  for(int i=0; i<9; i++) g_chi2_pars_MC[i] = new TGraph(50000);
  for_percent = 0;
  ...
  for(int j=0; j<9; j++){
    ...
    //reset parameters
    for(int k=0; k<9; k++) f_NewParam_MC_error->FixParameter(k,fit_result_MC->Parameter(k));
    ...
    for(int i=0; i<50000; i++){
      ...
      if(j==0)  varied_par_MC = (pars_MC[j]-400) + pars_MC[j]/100000 * i;
      if(j==1)  varied_par_MC = (pars_MC[j]+3) + pars_MC[j]/100000 * i;
      if(j==2)  varied_par_MC = (pars_MC[j]+2) + pars_MC[j]/1000000 * i;
      if(j==3)  varied_par_MC = (pars_MC[j]+2) + pars_MC[j]/100000 * i;
      if(j==4)  varied_par_MC = (pars_MC[j]-1.5) + pars_MC[j]/100000 * i;
      if(j==5)  varied_par_MC = (pars_MC[j]+2) + pars_MC[j]/1000000 * i;
      if(j==6)  varied_par_MC = (pars_MC[j]-0.002) + pars_MC[j]/10000000 * i;
      if(j==7)  varied_par_MC = (pars_MC[j]+0.002) + pars_MC[j]/10000000 * i;
      if(j==8)  varied_par_MC = (pars_MC[j]+0.05) + pars_MC[j]/100000 * i;
      ...
      // if(i%500 == 0) cout << "\r"  << for_percent/3500  << "%, " <<" Param Value "<<pars_MC[j]<<  " Parameter " << j << ", Fit No. " << i  << ", current chi2: " << chi2_tmp_MC << " at current parametervalue: " << varied_par_MC << "           "  << endl;
  ...
  TLine* l_pars_dn_MC[9];
  TLine* l_pars_up_MC[9];
  TLine* l_pars_central_MC[9];
  for(int i=0; i<9; i++){
  ...
  TCanvas* c_chi2_p6_MC = new TCanvas("c_chi2_p6_MC", "chi2 (p6)_MC", 1);
  gPad->SetTickx();
  gPad->SetTicky();
  g_chi2_pars_MC[6]->Draw();
  l_pars_up_MC[6]->Draw("SAME");
  l_pars_dn_MC[6]->Draw("SAME");
  l_pars_central_MC[6]->Draw("SAME");
  c_chi2_p6_MC->Print(folder + "Chi2_MC_p6.eps");

  TCanvas* c_chi2_p7_MC = new TCanvas("c_chi2_p7_MC", "chi2 (p7)_MC", 1);
  gPad->SetTickx();
  gPad->SetTicky();
  g_chi2_pars_MC[7]->Draw();
  l_pars_up_MC[7]->Draw("SAME");
  l_pars_dn_MC[7]->Draw("SAME");
  l_pars_central_MC[7]->Draw("SAME");
  c_chi2_p7_MC->Print(folder + "Chi2_MC_p7.eps");

 TCanvas* c_chi2_p8_MC = new TCanvas("c_chi2_p8_MC", "chi2 (p8)_MC", 1);
  gPad->SetTickx();
  gPad->SetTicky();
  g_chi2_pars_MC[8]->Draw();
  l_pars_up_MC[8]->Draw("SAME");
  l_pars_dn_MC[8]->Draw("SAME");
  l_pars_central_MC[8]->Draw("SAME");
  c_chi2_p8_MC->Print(folder + "Chi2_MC_p8.eps");
  ...
  TF1* f_NewParam_MC_up1 = new TF1("f_NewParam_MC_up1", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_dn1 = new TF1("f_NewParam_MC_dn1", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_up2 = new TF1("f_NewParam_MC_up2", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_dn2 = new TF1("f_NewParam_MC_dn2", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_up3 = new TF1("f_NewParam_MC_up3", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_dn3 = new TF1("f_NewParam_MC_dn3", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_up4 = new TF1("f_NewParam_MC_up4", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_dn4 = new TF1("f_NewParam_MC_dn4", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_up5 = new TF1("f_NewParam_MC_up5", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_dn5 = new TF1("f_NewParam_MC_dn5", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_up6 = new TF1("f_NewParam_MC_up6", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_dn6 = new TF1("f_NewParam_MC_dn6", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_up7 = new TF1("f_NewParam_MC_up7", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_dn7 = new TF1("f_NewParam_MC_dn7", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_up8 = new TF1("f_NewParam_MC_up8", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_dn8 = new TF1("f_NewParam_MC_dn8", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_up9 = new TF1("f_NewParam_MC_up9", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_dn9 = new TF1("f_NewParam_MC_dn9", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_upall = new TF1("f_NewParam_MC_upall", c_formula_MC,40, 180);
  TF1* f_NewParam_MC_dnall = new TF1("f_NewParam_MC_dnall", c_formula_MC,40, 180);
  ...
  for(int i=0; i<9; i++){
    ...
    f_NewParam_MC_up8->FixParameter(i,fit_result_MC->Parameter(i));
    f_NewParam_MC_dn8->FixParameter(i,fit_result_MC->Parameter(i));
    f_NewParam_MC_up9->FixParameter(i,fit_result_MC->Parameter(i));
    f_NewParam_MC_dn9->FixParameter(i,fit_result_MC->Parameter(i));
    ...
    if(i==0){
      ...
      f_NewParam_MC_up8->FixParameter(i,fit_result_MC->Parameter(i) + err_pars_up_MC[i]);
      f_NewParam_MC_dn8->FixParameter(i,fit_result_MC->Parameter(i) - err_pars_dn_MC[i]);
    }
  }

  TCanvas* cupdnMC = new TCanvas("cupdnMC", "Functions varied up and down, MC",10,10,700,700);
  gPad->SetTickx();
  gPad->SetTicky();
  ...
  f_NewParam_MC_up7->SetLineColor(45);
  f_NewParam_MC_up7->Draw("SAME");
  leg ->AddEntry(f_NewParam_MC_up7,"Par. 7 up", "l");

  f_NewParam_MC_dn7->SetLineColor(48);
  f_NewParam_MC_dn7->Draw("SAME");
  leg ->AddEntry(f_NewParam_MC_dn7,"Par. 7 down", "l");

  f_NewParam_MC_up8->SetLineColor(20);
  f_NewParam_MC_up8->Draw("SAME");
  leg ->AddEntry(f_NewParam_MC_up8,"Par. 8 up", "l");

  f_NewParam_MC_dn8->SetLineColor(25);
  f_NewParam_MC_dn8->Draw("SAME");
  leg ->AddEntry(f_NewParam_MC_dn8,"Par. 8 down", "l");

  f_NewParam_MC_up9->SetLineColor(30);
  f_NewParam_MC_up9->Draw("SAME");
  leg ->AddEntry(f_NewParam_MC_up9,"Par. 9 up", "l");

  f_NewParam_MC_dn9->SetLineColor(27);
  f_NewParam_MC_dn9->Draw("SAME");
  leg ->AddEntry(f_NewParam_MC_dn9,"Par. 9 down", "l");
  ...
  //Par1
  TF1 *MC_Eff_NewPar_up1_f =new TF1("MC_Eff_NewPar_up1_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_up1_f->SetParameter(i, f_NewParam_MC_up1->GetParameter(i));
  Double_t num_MC_NewPar_up1_before = MC_Eff_NewPar_up1_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParUp1 before tagger:   "<< num_MC_NewPar_up1_before <<endl;

  TF1 *MC_Eff_NewPar_down1_f =new TF1("MC_Eff_NewPar_down1_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_down1_f->SetParameter(i, f_NewParam_MC_dn1->GetParameter(i));
  Double_t num_MC_NewPar_down1_before = MC_Eff_NewPar_down1_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParDown1 before tagger:   "<< num_MC_NewPar_down1_before <<endl;

  //Par2
  TF1 *MC_Eff_NewPar_up2_f =new TF1("MC_Eff_NewPar_up2_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_up2_f->SetParameter(i, f_NewParam_MC_up2->GetParameter(i));
  Double_t num_MC_NewPar_up2_before = MC_Eff_NewPar_up2_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParUp2 before tagger:   "<< num_MC_NewPar_up2_before <<endl;

  TF1 *MC_Eff_NewPar_down2_f =new TF1("MC_Eff_NewPar_down2_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_down2_f->SetParameter(i, f_NewParam_MC_dn2->GetParameter(i));
  Double_t num_MC_NewPar_down2_before = MC_Eff_NewPar_down2_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParDown2 before tagger:   "<< num_MC_NewPar_down2_before <<endl;

  //Par3
  TF1 *MC_Eff_NewPar_up3_f =new TF1("MC_Eff_NewPar_up3_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_up3_f->SetParameter(i, f_NewParam_MC_up3->GetParameter(i));
  Double_t num_MC_NewPar_up3_before = MC_Eff_NewPar_up3_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParUp3 before tagger:   "<< num_MC_NewPar_up3_before <<endl;

  TF1 *MC_Eff_NewPar_down3_f =new TF1("MC_Eff_NewPar_down3_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_down3_f->SetParameter(i, f_NewParam_MC_dn3->GetParameter(i));
  Double_t num_MC_NewPar_down3_before = MC_Eff_NewPar_down3_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParDown3 before tagger:   "<< num_MC_NewPar_down3_before <<endl;

  //Par4
  TF1 *MC_Eff_NewPar_up4_f =new TF1("MC_Eff_NewPar_up4_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_up4_f->SetParameter(i, f_NewParam_MC_up4->GetParameter(i));
  Double_t num_MC_NewPar_up4_before = MC_Eff_NewPar_up4_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParUp4 before tagger:   "<< num_MC_NewPar_up4_before <<endl;

  TF1 *MC_Eff_NewPar_down4_f =new TF1("MC_Eff_NewPar_down4_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_down4_f->SetParameter(i, f_NewParam_MC_dn4->GetParameter(i));
  Double_t num_MC_NewPar_down4_before = MC_Eff_NewPar_down4_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParDown4 before tagger:   "<< num_MC_NewPar_down4_before <<endl;

  //Par5
  TF1 *MC_Eff_NewPar_up5_f =new TF1("MC_Eff_NewPar_up5_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_up5_f->SetParameter(i, f_NewParam_MC_up5->GetParameter(i));
  Double_t num_MC_NewPar_up5_before = MC_Eff_NewPar_up5_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParUp5 before tagger:   "<< num_MC_NewPar_up5_before <<endl;

  TF1 *MC_Eff_NewPar_down5_f =new TF1("MC_Eff_NewPar_down5_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_down5_f->SetParameter(i, f_NewParam_MC_dn5->GetParameter(i));
  Double_t num_MC_NewPar_down5_before = MC_Eff_NewPar_down5_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParDown5 before tagger:   "<< num_MC_NewPar_down5_before <<endl;

  //Par6
  TF1 *MC_Eff_NewPar_up6_f =new TF1("MC_Eff_NewPar_up6_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_up6_f->SetParameter(i, f_NewParam_MC_up6->GetParameter(i));
  Double_t num_MC_NewPar_up6_before = MC_Eff_NewPar_up6_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParUp6 before tagger:   "<< num_MC_NewPar_up6_before <<endl;

  TF1 *MC_Eff_NewPar_down6_f =new TF1("MC_Eff_NewPar_down6_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_down6_f->SetParameter(i, f_NewParam_MC_dn6->GetParameter(i));
  Double_t num_MC_NewPar_down6_before = MC_Eff_NewPar_down6_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParDown6 before tagger:   "<< num_MC_NewPar_down6_before <<endl;

 //Par7
  TF1 *MC_Eff_NewPar_up7_f =new TF1("MC_Eff_NewPar_up7_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_up7_f->SetParameter(i, f_NewParam_MC_up7->GetParameter(i));
  Double_t num_MC_NewPar_up7_before = MC_Eff_NewPar_up7_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParUp7 before tagger:   "<< num_MC_NewPar_up7_before <<endl;

  TF1 *MC_Eff_NewPar_down7_f =new TF1("MC_Eff_NewPar_down7_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_down7_f->SetParameter(i, f_NewParam_MC_dn7->GetParameter(i));
  Double_t num_MC_NewPar_down7_before = MC_Eff_NewPar_down7_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParDown7 before tagger:   "<< num_MC_NewPar_down7_before <<endl;
 

 //Par8
  TF1 *MC_Eff_NewPar_up8_f =new TF1("MC_Eff_NewPar_up8_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_up8_f->SetParameter(i, f_NewParam_MC_up8->GetParameter(i));
  Double_t num_MC_NewPar_up8_before = MC_Eff_NewPar_up8_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParUp8 before tagger:   "<< num_MC_NewPar_up8_before <<endl;

  TF1 *MC_Eff_NewPar_down8_f =new TF1("MC_Eff_NewPar_down8_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_down8_f->SetParameter(i, f_NewParam_MC_dn8->GetParameter(i));
  Double_t num_MC_NewPar_down8_before = MC_Eff_NewPar_down8_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParDown8 before tagger:   "<< num_MC_NewPar_down8_before <<endl;
 


 //Par9
  TF1 *MC_Eff_NewPar_up9_f =new TF1("MC_Eff_NewPar_up9_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_up9_f->SetParameter(i, f_NewParam_MC_up9->GetParameter(i));
  Double_t num_MC_NewPar_up9_before = MC_Eff_NewPar_up9_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParUp9 before tagger:   "<< num_MC_NewPar_up9_before <<endl;

  TF1 *MC_Eff_NewPar_down9_f =new TF1("MC_Eff_NewPar_down9_f",c_formula_MC_signal, 40,180);
  for(int i=0;i<9;i++)MC_Eff_NewPar_down9_f->SetParameter(i, f_NewParam_MC_dn9->GetParameter(i));
  Double_t num_MC_NewPar_down9_before = MC_Eff_NewPar_down9_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"MC number for ParDown9 before tagger:   "<< num_MC_NewPar_down9_before <<endl;
  ...
  if(num_MC_NewPar_up8_before>num_MC_before) {par8_up=num_MC_NewPar_up8_before;par8_down=num_MC_NewPar_down8_before;}
  else {par8_down=num_MC_NewPar_up8_before;par8_up=num_MC_NewPar_down8_before;}

  if(num_MC_NewPar_up9_before>num_MC_before) {par9_up=num_MC_NewPar_up9_before;par9_down=num_MC_NewPar_down9_before;}
  else {par9_down=num_MC_NewPar_up9_before;par9_up=num_MC_NewPar_down9_before;}

  Double_t all_up= TMath::Power(par1_up-num_MC_before,2)+TMath::Power(par2_up-num_MC_before,2)+TMath::Power(par3_up-num_MC_before,2)+TMath::Power(par4_up-num_MC_before,2)+TMath::Power(par5_up-num_MC_before,2)+TMath::Power(par6_up-num_MC_before,2)+TMath::Power(par7_up-num_MC_before,2)+TMath::Power(par8_up-num_MC_before,2);
  Double_t all_down= TMath::Power(par1_down-num_MC_before,2)+TMath::Power(par2_down-num_MC_before,2)+TMath::Power(par3_down-num_MC_before,2)+TMath::Power(par4_down-num_MC_before,2)+TMath::Power(par5_down-num_MC_before,2)+TMath::Power(par6_down-num_MC_before,2)+TMath::Power(par7_down-num_MC_before,2)+TMath::Power(par8_down-num_MC_before,2);
  ...
  myfile << "Parameter 8 Upvariation "<< par8_up-num_MC_before<<endl;
  myfile << "Parameter 8 Downvariation "<< par8_down-num_MC_before<<endl;
  myfile << "Parameter 9 Upvariation "<< par9_up-num_MC_before<<endl;
  myfile << "Parameter 9 Downvariation "<< par9_down-num_MC_before<<endl;
  myfile << "----------------------------------------------------------------------------------------------------------"<<endl;
 ...
 sstr_MC_bkg  << "("<< "(" <<g_tr_MC[0]<<"*[0]+" <<g_tr_MC[1]<<"*[1]+" <<g_tr_MC[2]<<"*[2]+" <<g_tr_MC[3]<<"*[3]+" <<g_tr_MC[4]<<"*[4]+" <<g_tr_MC[5]<<"*[5]+" <<g_tr_MC[6]<<"*[6]+" <<g_tr_MC[7]<<"*[7]+" <<g_tr_MC[8]<<"*[8]" << ")*(1.-TMath::Power(1+TMath::Exp(-(x-("<<  h_tr_MC[0] << "*[0]+" <<  h_tr_MC[1] << "*[1]+"<<  h_tr_MC[2] << "*[2]+"<<  h_tr_MC[3] << "*[3]+"<<  h_tr_MC[4] << "*[4]+"<<  h_tr_MC[5] << "*[5]+"<<  h_tr_MC[6] << "*[6]+"<<  h_tr_MC[7] << "*[7]+"<<  h_tr_MC[8]  <<"))/("<<  i_tr_MC[0] << "*[0]+" <<  i_tr_MC[1] << "*[1]+"<<  i_tr_MC[2] << "*[2]+"<<  i_tr_MC[3] << "*[3]+"<<  i_tr_MC[4] << "*[4]+"<<  i_tr_MC[5] << "*[5]+"<<  i_tr_MC[6] << "*[6]+"<<  i_tr_MC[7] << "*[7]+"<<  i_tr_MC[8] <<")),-1))" <<")";
  ...
  //Integrate over all up and down variation itself
  //Par1
  TF1 *MC_bkg_Eff_NewPar_up1_f =new TF1("MC_bkg_Eff_NewPar_up1_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_up1_f->SetParameter(i, f_NewParam_MC_up1->GetParameter(i));
  Double_t num_MC_bkg_NewPar_up1_before = MC_bkg_Eff_NewPar_up1_f->Integral(40,180) / 2;
  cout<<"MC number for ParUp1 before tagger:   "<< num_MC_bkg_NewPar_up1_before <<endl;

  TF1 *MC_bkg_Eff_NewPar_down1_f =new TF1("MC_bkg_Eff_NewPar_down1_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_down1_f->SetParameter(i, f_NewParam_MC_dn1->GetParameter(i));
  Double_t num_MC_bkg_NewPar_down1_before = MC_bkg_Eff_NewPar_down1_f->Integral(40,180) / 2;
  cout<<"MC number for ParDown1 before tagger:   "<< num_MC_bkg_NewPar_down1_before <<endl;

  //Par2
  TF1 *MC_bkg_Eff_NewPar_up2_f =new TF1("MC_bkg_Eff_NewPar_up2_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_up2_f->SetParameter(i, f_NewParam_MC_up2->GetParameter(i));
  Double_t num_MC_bkg_NewPar_up2_before = MC_bkg_Eff_NewPar_up2_f->Integral(40,180) / 2;
  cout<<"MC number for ParUp2 before tagger:   "<< num_MC_bkg_NewPar_up2_before <<endl;

  TF1 *MC_bkg_Eff_NewPar_down2_f =new TF1("MC_bkg_Eff_NewPar_down2_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_down2_f->SetParameter(i, f_NewParam_MC_dn2->GetParameter(i));
  Double_t num_MC_bkg_NewPar_down2_before = MC_bkg_Eff_NewPar_down2_f->Integral(40,180) / 2;
  cout<<"MC number for ParDown2 before tagger:   "<< num_MC_bkg_NewPar_down2_before <<endl;

  //Par3
  TF1 *MC_bkg_Eff_NewPar_up3_f =new TF1("MC_bkg_Eff_NewPar_up3_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_up3_f->SetParameter(i, f_NewParam_MC_up3->GetParameter(i));
  Double_t num_MC_bkg_NewPar_up3_before = MC_bkg_Eff_NewPar_up3_f->Integral(40,180) / 2;
  cout<<"MC number for ParUp3 before tagger:   "<< num_MC_bkg_NewPar_up3_before <<endl;

  TF1 *MC_bkg_Eff_NewPar_down3_f =new TF1("MC_bkg_Eff_NewPar_down3_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_down3_f->SetParameter(i, f_NewParam_MC_dn3->GetParameter(i));
  Double_t num_MC_bkg_NewPar_down3_before = MC_bkg_Eff_NewPar_down3_f->Integral(40,180) / 2;
  cout<<"MC number for ParDown3 before tagger:   "<< num_MC_bkg_NewPar_down3_before <<endl;

  //Par4
  TF1 *MC_bkg_Eff_NewPar_up4_f =new TF1("MC_bkg_Eff_NewPar_up4_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_up4_f->SetParameter(i, f_NewParam_MC_up4->GetParameter(i));
  Double_t num_MC_bkg_NewPar_up4_before = MC_bkg_Eff_NewPar_up4_f->Integral(40,180) / 2;
  cout<<"MC number for ParUp4 before tagger:   "<< num_MC_bkg_NewPar_up4_before <<endl;

  TF1 *MC_bkg_Eff_NewPar_down4_f =new TF1("MC_bkg_Eff_NewPar_down4_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_down4_f->SetParameter(i, f_NewParam_MC_dn4->GetParameter(i));
  Double_t num_MC_bkg_NewPar_down4_before = MC_bkg_Eff_NewPar_down4_f->Integral(40,180) / 2;
  cout<<"MC number for ParDown4 before tagger:   "<< num_MC_bkg_NewPar_down4_before <<endl;

  //Par5
  TF1 *MC_bkg_Eff_NewPar_up5_f =new TF1("MC_bkg_Eff_NewPar_up5_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_up5_f->SetParameter(i, f_NewParam_MC_up5->GetParameter(i));
  Double_t num_MC_bkg_NewPar_up5_before = MC_bkg_Eff_NewPar_up5_f->Integral(40,180) / 2;
  cout<<"MC number for ParUp5 before tagger:   "<< num_MC_bkg_NewPar_up5_before <<endl;

  TF1 *MC_bkg_Eff_NewPar_down5_f =new TF1("MC_bkg_Eff_NewPar_down5_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_down5_f->SetParameter(i, f_NewParam_MC_dn5->GetParameter(i));
  Double_t num_MC_bkg_NewPar_down5_before = MC_bkg_Eff_NewPar_down5_f->Integral(40,180) / 2;
  cout<<"MC number for ParDown5 before tagger:   "<< num_MC_bkg_NewPar_down5_before <<endl;

  //Par6
  TF1 *MC_bkg_Eff_NewPar_up6_f =new TF1("MC_bkg_Eff_NewPar_up6_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_up6_f->SetParameter(i, f_NewParam_MC_up6->GetParameter(i));
  Double_t num_MC_bkg_NewPar_up6_before = MC_bkg_Eff_NewPar_up6_f->Integral(40,180) / 2;
  cout<<"MC number for ParUp6 before tagger:   "<< num_MC_bkg_NewPar_up6_before <<endl;

  TF1 *MC_bkg_Eff_NewPar_down6_f =new TF1("MC_bkg_Eff_NewPar_down6_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_down6_f->SetParameter(i, f_NewParam_MC_dn6->GetParameter(i));
  Double_t num_MC_bkg_NewPar_down6_before = MC_bkg_Eff_NewPar_down6_f->Integral(40,180) / 2;
  cout<<"MC number for ParDown6 before tagger:   "<< num_MC_bkg_NewPar_down6_before <<endl;

 //Par7
  TF1 *MC_bkg_Eff_NewPar_up7_f =new TF1("MC_bkg_Eff_NewPar_up7_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_up7_f->SetParameter(i, f_NewParam_MC_up7->GetParameter(i));
  Double_t num_MC_bkg_NewPar_up7_before = MC_bkg_Eff_NewPar_up7_f->Integral(40,180) / 2;
  cout<<"MC number for ParUp7 before tagger:   "<< num_MC_bkg_NewPar_up7_before <<endl;

  TF1 *MC_bkg_Eff_NewPar_down7_f =new TF1("MC_bkg_Eff_NewPar_down7_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_down7_f->SetParameter(i, f_NewParam_MC_dn7->GetParameter(i));
  Double_t num_MC_bkg_NewPar_down7_before = MC_bkg_Eff_NewPar_down7_f->Integral(40,180) / 2;
  cout<<"MC number for ParDown7 before tagger:   "<< num_MC_bkg_NewPar_down7_before <<endl;


 //Par8
  TF1 *MC_bkg_Eff_NewPar_up8_f =new TF1("MC_bkg_Eff_NewPar_up8_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_up8_f->SetParameter(i, f_NewParam_MC_up8->GetParameter(i));
  Double_t num_MC_bkg_NewPar_up8_before = MC_bkg_Eff_NewPar_up8_f->Integral(40,180) / 2;
  cout<<"MC number for ParUp8 before tagger:   "<< num_MC_bkg_NewPar_up8_before <<endl;

  TF1 *MC_bkg_Eff_NewPar_down8_f =new TF1("MC_bkg_Eff_NewPar_down8_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_down8_f->SetParameter(i, f_NewParam_MC_dn8->GetParameter(i));
  Double_t num_MC_bkg_NewPar_down8_before = MC_bkg_Eff_NewPar_down8_f->Integral(40,180) / 2;
  cout<<"MC number for ParDown8 before tagger:   "<< num_MC_bkg_NewPar_down8_before <<endl;


 //Par9
  TF1 *MC_bkg_Eff_NewPar_up9_f =new TF1("MC_bkg_Eff_NewPar_up9_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_up9_f->SetParameter(i, f_NewParam_MC_up9->GetParameter(i));
  Double_t num_MC_bkg_NewPar_up9_before = MC_bkg_Eff_NewPar_up9_f->Integral(40,180) / 2;
  cout<<"MC number for ParUp9 before tagger:   "<< num_MC_bkg_NewPar_up9_before <<endl;

  TF1 *MC_bkg_Eff_NewPar_down9_f =new TF1("MC_bkg_Eff_NewPar_down9_f",c_formula_MC_bkg, 40,180);
  for(int i=0;i<9;i++)MC_bkg_Eff_NewPar_down9_f->SetParameter(i, f_NewParam_MC_dn9->GetParameter(i));
  Double_t num_MC_bkg_NewPar_down9_before = MC_bkg_Eff_NewPar_down9_f->Integral(40,180) / 2;
  cout<<"MC number for ParDown9 before tagger:   "<< num_MC_bkg_NewPar_down9_before <<endl;
  ...
  if(num_MC_bkg_NewPar_up8_before>number_back_MC_miss) {par8_up=num_MC_bkg_NewPar_up8_before;par8_down=num_MC_bkg_NewPar_down8_before;}
  else {par8_down=num_MC_bkg_NewPar_up8_before;par8_up=num_MC_bkg_NewPar_down8_before;}

  if(num_MC_bkg_NewPar_up9_before>number_back_MC_miss) {par9_up=num_MC_bkg_NewPar_up9_before;par9_down=num_MC_bkg_NewPar_down9_before;}
  else {par9_down=num_MC_bkg_NewPar_up9_before;par9_up=num_MC_bkg_NewPar_down9_before;}

  all_up= TMath::Power(par1_up-number_back_MC_miss,2)+TMath::Power(par2_up-number_back_MC_miss,2)+TMath::Power(par3_up-number_back_MC_miss,2)+TMath::Power(par4_up-number_back_MC_miss,2)+TMath::Power(par5_up-number_back_MC_miss,2)+TMath::Power(par6_up-number_back_MC_miss,2)+TMath::Power(par7_up-number_back_MC_miss,2)+TMath::Power(par8_up-number_back_MC_miss,2);
   all_down= TMath::Power(par1_down-number_back_MC_miss,2)+TMath::Power(par2_down-number_back_MC_miss,2)+TMath::Power(par3_down-number_back_MC_miss,2)+TMath::Power(par4_down-number_back_MC_miss,2)+TMath::Power(par5_down-number_back_MC_miss,2)+TMath::Power(par6_down-number_back_MC_miss,2)+TMath::Power(par7_down-number_back_MC_miss,2)+TMath::Power(par8_down-number_back_MC_miss,2);
  ...
  myfile << "Parameter 8 Upvariation "<< par8_up-number_back_MC_miss<<endl;
  myfile << "Parameter 8 Downvariation "<< par8_down-number_back_MC_miss<<endl;
  myfile << "Parameter 9 Upvariation "<< par9_up-number_back_MC_miss<<endl;
  myfile << "Parameter 9 Downvariation "<< par9_down-number_back_MC_miss<<endl;
  myfile << "----------------------------------------------------------------------------------------------------------"<<endl;
  myfile << "all up variations quadraticly added: "<<TMath::Sqrt(all_up)<<endl;
  myfile << "all down variations quadraticly added: -"<<TMath::Sqrt(all_down)<<endl;
  ...
  //Hier
  //correction for MC mistagrate
  Double_t count_error_signal;
  Double_t count_num_MC_before = TTbar_matched_dr04->IntegralAndError(13,92,count_error_signal);
  Double_t number_sig_04 = ((TH1F*)TTbar_matched_dr04_f->Get("tagger_zwtag/reco_mass_W"))->IntegralAndError(13,92,count_error_signal);
  Double_t eff_MC = (number_sig_04)/count_num_MC_before; 

  Double_t num_bkg_prime = number_back - num_sig_in_bkg_before * eff_MC;
  // Double_t num_bkg_prime = number_back;
  myfile <<"Hier  eff_MC  "<<eff_MC<<"  num_back_prime  "<<num_bkg_prime <<"  number_back  "<<number_back<<"  num_sig_in_bkg_before  "<<num_sig_in_bkg_before<<endl;
  myfile <<"SF corection factor for mistag rate data"<<sf<<endl;
  ...
  //   Double_t mistag_rate_MC = num_bkg_prime/number_back_MC_miss;
  ...
  Double_t error_mistagrate_MC_up = TMath::Sqrt(TMath::Power((1/number_back_MC_miss)*error_back,2) + TMath::Power((num_bkg_prime/number_back_MC_miss/number_back_MC_miss)*TMath::Sqrt(all_up),2) );
  Double_t error_mistagrate_MC_down = TMath::Sqrt(TMath::Power((1/number_back_MC_miss)*error_back,2) + TMath::Power((num_bkg_prime/number_back_MC_miss/number_back_MC_miss)*TMath::Sqrt(all_down),2) );
  Double_t error_mistagrate_data_up = TMath::Sqrt((TMath::Power((1/number_back_MC_miss)*error_back,2) + TMath::Power((num_bkg_prime/number_back_MC_miss/number_back_MC_miss)*TMath::Sqrt(all_up),2)) *TMath::Power(corr_mistagrate,2) + TMath::Power(mistag_rate_MC* error_corr_mistagrate_up,2));
  Double_t error_mistagrate_data_down = TMath::Sqrt((TMath::Power((1/number_back_MC_miss)*error_back,2) + TMath::Power((num_bkg_prime/number_back_MC_miss/number_back_MC_miss)*TMath::Sqrt(all_down),2)) *TMath::Power(corr_mistagrate,2) + TMath::Power(mistag_rate_MC* error_corr_mistagrate_down,2));
  ...
  // myfile << "Anzahl sig nachher:  "<<number_sig<<"  +Anzahl nachher back "<< number_back <<" - Anzahl back vorher "<< number_back_MC_miss <<"  *miss" <<mistag_rate_MC<<endl;

  Double_t num_MC_after = number_sig+ number_back - number_back_MC_miss * mistag_rate_MC;
  // Double_t num_MC_after = number_sig+ num_bkg_prime - number_back_MC_miss * mistag_rate_MC;
  cout << "Anzahl sig nachher:  "<<number_sig<<"  +Anzahl nachher back "<< num_bkg_prime <<" - Anzahl back vorher "<< number_back_MC_miss <<"  *miss" <<mistag_rate_MC<<endl;
  myfile << "Anzahl sig nachher:  "<<number_sig<<"  +Anzahl nachher back "<< num_bkg_prime <<" - Anzahl back vorher "<< number_back_MC_miss <<"  *miss" <<mistag_rate_MC<<endl;
  ...
  const double h_data = fit_data_result->Parameter(7);
  const double i_data = fit_data_result->Parameter(8);
  const double old_params_data[9] = {a_data,b_data,c_data,d_data,e_data,f_data,g_data,h_data,i_data};
  const TVectorD V_Old_Param_data(9,old_params_data);
 ...
 //  /*                          */
  ...
  double a_tr_data[9], b_tr_data[9], c_tr_data[9], d_tr_data[9], e_tr_data[9], f_tr_data[9], g_tr_data[9], h_tr_data[9], i_tr_data[9];
  for (int i=0; i<9; i++){
    ...
    h_tr_data[i] = TMatrixDRow(M_Dummy_data,7)[i];
    i_tr_data[i] = TMatrixDRow(M_Dummy_data,8)[i];
  }

  //string of new fit function with uncorrelated parameters
  stringstream sstr_data;
  sstr_data  << "((" <<d_tr_data[0]<<"*[0]+" <<d_tr_data[1]<<"*[1]+" <<d_tr_data[2]<<"*[2]+" <<d_tr_data[3]<<"*[3]+" <<d_tr_data[4]<<"*[4]+" <<d_tr_data[5]<<"*[5]+" <<d_tr_data[6]<<"*[6]+" <<d_tr_data[7]<<"*[7]+" <<d_tr_data[8]<<"*[8]" << ")* TMath::Voigt(x-(""("<<  c_tr_data[0] << "*[0]+" <<  c_tr_data[1] << "*[1]+"<<  c_tr_data[2] << "*[2]+"<<  c_tr_data[3] << "*[3]+"<<  c_tr_data[4] << "*[4]+"<<  c_tr_data[5] << "*[5]+"<<  c_tr_data[6] << "*[6]+"<<  c_tr_data[7] << "*[7]+"<<  c_tr_data[8] << "*[8]"<<")+("<< e_tr_data[0] << "*[0]+" <<  e_tr_data[1] << "*[1]+"<<  e_tr_data[2] << "*[2]+"<<  e_tr_data[3] << "*[3]+"<<  e_tr_data[4] << "*[4]+"<<  e_tr_data[5] << "*[5]+"<<  e_tr_data[6] << "*[6]+"<<  e_tr_data[7] << "*[7]+"<<  e_tr_data[8] << "*[8]" <<")*x),("<<"("<<  a_tr_data[0] << "*[0]+" <<  a_tr_data[1] << "*[1]+"<<  a_tr_data[2] << "*[2]+"<<  a_tr_data[3] << "*[3]+"<<  a_tr_data[4] << "*[4]+"<<  a_tr_data[5] << "*[5]+"<<  a_tr_data[6] << "*[6]+"<<  a_tr_data[7] << "*[7]+"<<  a_tr_data[8] << "*[8]" <<")+("<< f_tr_data[0] << "*[0]+" <<  f_tr_data[1] << "*[1]+"<<  f_tr_data[2] << "*[2]+"<<  f_tr_data[3] << "*[3]+"<<  f_tr_data[4] << "*[4]+"<<  f_tr_data[5] << "*[5]+"<<  f_tr_data[6] << "*[6]+"<<  f_tr_data[7] << "*[7]+"<<  f_tr_data[8] << "*[8]" <<")*x),("<<  b_tr_data[0] << "*[0]+" <<  b_tr_data[1] << "*[1]+"<<  b_tr_data[2] << "*[2]+"<<  b_tr_data[3] << "*[3]+"<<  b_tr_data[4] << "*[4]+"<<  b_tr_data[5] << "*[5]+"<<  b_tr_data[6] << "*[6]+"<<  b_tr_data[7] << "*[7]+"<<  b_tr_data[8] << "*[8]" <<"),4"<<"))+("<< "(" <<g_tr_data[0]<<"*[0]+" <<g_tr_data[1]<<"*[1]+" <<g_tr_data[2]<<"*[2]+" <<g_tr_data[3]<<"*[3]+" <<g_tr_data[4]<<"*[4]+" <<g_tr_data[5]<<"*[5]+" <<g_tr_data[6]<<"*[6]+" <<g_tr_data[7]<<"*[7]+" <<g_tr_data[8]<<"*[8]" << ")*(1.-TMath::Power(1+TMath::Exp(-(x-("<<  h_tr_data[0] << "*[0]+" <<  h_tr_data[1] << "*[1]+"<<  h_tr_data[2] << "*[2]+"<<  h_tr_data[3] << "*[3]+"<<  h_tr_data[4] << "*[4]+"<<  h_tr_data[5] << "*[5]+"<<  h_tr_data[6] << "*[6]+"<<  h_tr_data[7] << "*[7]+"<<  h_tr_data[8]  <<"))/("<<  i_tr_data[0] << "*[0]+" <<  i_tr_data[1] << "*[1]+"<<  i_tr_data[2] << "*[2]+"<<  i_tr_data[3] << "*[3]+"<<  i_tr_data[4] << "*[4]+"<<  i_tr_data[5] << "*[5]+"<<  i_tr_data[6] << "*[6]+"<<  i_tr_data[7] << "*[7]+"<<  i_tr_data[8] <<")),-1))" <<")";
  ...
  //New fit fuction with uncoorelated parameters
  TF1* f_NewParam_data = new TF1("f_NewParam_data",c_formula_data,40,180);
  ...
  f_NewParam_data->SetParameter(6,V_New_Param_data[6]);
  f_NewParam_data->SetParameter(7,V_New_Param_data[7]);
  f_NewParam_data->FixParameter(8,V_New_Param_data[8]);
  f_NewParam_data->SetLineColor(kGreen+3);
  if(b_error)for(int i=40;i<181;i=i+5)cout <<"new: "<<f_NewParam_data->Eval(i)<<" old: "<< data_fit->Eval(i)<<endl;
  ...
  TCanvas* cfitnew_data = new TCanvas("cfitnewdata", "Fit function in new parameters, data",10,10,700,700);
  ...
  //define error function
  TF1* f_NewParam_data_error = new TF1("f_NewParam_data_error",c_formula_data,40,180);

  //fix all fit values
  TCanvas* c_dummy_data = new TCanvas("c_dummy_data", "Fits for chi2 in data", 10,10,700,700);
  for(int i=0; i<9; i++){
  ...
  //set up arrays to save the errors 
  double pars_data[9], pars_up_data[9], pars_dn_data[9], err_pars_up_data[9], err_pars_dn_data[9];
  for(int i=0; i<9; i++) pars_data[i] = f_NewParam_data_error->GetParameter(i);
  bool pars_up_set_data[9] = {false,false,false,false,false,false,false,false,false};
  bool pars_dn_set_data[9] = {false,false,false,false,false,false,false,false,false};
  TGraph* g_chi2_pars_data[9];
  for(int i=0; i<9; i++) g_chi2_pars_data[i] = new TGraph(50000);
  for_percent = 0;
  ...
  for(int j=0; j<9; j++){
    ...
    //reset parameters
    for(int k=0; k<9; k++) f_NewParam_data_error->FixParameter(k,fit_result_data->Parameter(k));
    ...
    for(int i=0; i<50000; i++){
      ...
      if(j==0)  varied_par_data = (pars_data[j]-500) + pars_data[j]/100000 * i;
      if(j==1)  varied_par_data = (pars_data[j]-5) + pars_data[j]/100000 * i;
      if(j==2)  varied_par_data = (pars_data[j]-20) + pars_data[j]/100000 * i;
      if(j==3)  varied_par_data = (pars_data[j]-2) + pars_data[j]/10000 * i;
      if(j==4)  varied_par_data = (pars_data[j]-2) - pars_data[j]/100000 * i;
      if(j==5)  varied_par_data = (pars_data[j]-1.5) - pars_data[j]/100000 * i;
      if(j==6)  varied_par_data = (pars_data[j]-0.005) - pars_data[j]/1000000 * i;
      if(j==7)  varied_par_data = (pars_data[j]-0.003) + pars_data[j]/10000000 * i;
      if(j==8)  varied_par_data = (pars_data[j]-0.5) - pars_data[j]/100000 * i;
      ...
      //  if(i%500 == 0) if(j==6)cout << "\r"  << for_percent/3500  << "%, " <<"Parameter Value "<< pars_data[j]<<  "  Parameter " << j << ", Fit No. " << i  << ", current chi2: " << chi2_tmp_data << " at current parametervalue: " << varied_par_data << "           "  << endl;
      //   if(i%500 == 0)cout << "\r"  << for_percent/3500  << "%, " <<"Parameter Value "<< pars_data[j]<<  "  Parameter " << j << ", Fit No. " << i  << ", current chi2: " << chi2_tmp_data << " at current parametervalue: " << varied_par_data << "           "  << endl;
  ...
  //define Line of the up and down variation in chi2
  TLine* l_pars_dn_data[9];
  TLine* l_pars_up_data[9];
  TLine* l_pars_central_data[9];
  for(int i=0; i<9; i++){
  ...
  TCanvas* c_chi2_p6_data = new TCanvas("c_chi2_p6_data", "chi2 (p6)_data", 1);
  gPad->SetTickx();
  gPad->SetTicky();
  ...
  c_chi2_p6_data->Print(folder + "Chi2_data_p6.eps");

  TCanvas* c_chi2_p7_data = new TCanvas("c_chi2_p7_data", "chi2 (p7)_data", 1);
  gPad->SetTickx();
  gPad->SetTicky();
  g_chi2_pars_data[7]->Draw();
  l_pars_up_data[7]->Draw("SAME");
  l_pars_dn_data[7]->Draw("SAME");
  l_pars_central_data[7]->Draw("SAME");
  c_chi2_p7_data->Print(folder + "Chi2_data_p7.eps");

  TCanvas* c_chi2_p8_data = new TCanvas("c_chi2_p8_data", "chi2 (p8)_data", 1);
  gPad->SetTickx();
  gPad->SetTicky();
  g_chi2_pars_data[8]->Draw();
  l_pars_up_data[8]->Draw("SAME");
  l_pars_dn_data[8]->Draw("SAME");
  l_pars_central_data[8]->Draw("SAME");
  c_chi2_p8_data->Print(folder + "Chi2_data_p8.eps");
  ...
  TF1* f_NewParam_data_up1 = new TF1("f_NewParam_data_up1", c_formula_data,40, 180);
  TF1* f_NewParam_data_dn1 = new TF1("f_NewParam_data_dn1", c_formula_data,40, 180);
  TF1* f_NewParam_data_up2 = new TF1("f_NewParam_data_up2", c_formula_data,40, 180);
  TF1* f_NewParam_data_dn2 = new TF1("f_NewParam_data_dn2", c_formula_data,40, 180);
  TF1* f_NewParam_data_up3 = new TF1("f_NewParam_data_up3", c_formula_data,40, 180);
  TF1* f_NewParam_data_dn3 = new TF1("f_NewParam_data_dn3", c_formula_data,40, 180);
  TF1* f_NewParam_data_up4 = new TF1("f_NewParam_data_up4", c_formula_data,40, 180);
  TF1* f_NewParam_data_dn4 = new TF1("f_NewParam_data_dn4", c_formula_data,40, 180);
  TF1* f_NewParam_data_up5 = new TF1("f_NewParam_data_up5", c_formula_data,40, 180);
  TF1* f_NewParam_data_dn5 = new TF1("f_NewParam_data_dn5", c_formula_data,40, 180);
  TF1* f_NewParam_data_up6 = new TF1("f_NewParam_data_up6", c_formula_data,40, 180);
  TF1* f_NewParam_data_dn6 = new TF1("f_NewParam_data_dn6", c_formula_data,40, 180);
  TF1* f_NewParam_data_up7 = new TF1("f_NewParam_data_up7", c_formula_data,40, 180);
  TF1* f_NewParam_data_dn7 = new TF1("f_NewParam_data_dn7", c_formula_data,40, 180);
  TF1* f_NewParam_data_up8 = new TF1("f_NewParam_data_up8", c_formula_data,40, 180);
  TF1* f_NewParam_data_dn8 = new TF1("f_NewParam_data_dn8", c_formula_data,40, 180);
  TF1* f_NewParam_data_up9 = new TF1("f_NewParam_data_up9", c_formula_data,40, 180);
  TF1* f_NewParam_data_dn9 = new TF1("f_NewParam_data_dn9", c_formula_data,40, 180);
  TF1* f_NewParam_data_upall = new TF1("f_NewParam_data_upall", c_formula_data,40, 180);
  TF1* f_NewParam_data_dnall = new TF1("f_NewParam_data_dnall", c_formula_data,40, 180);
  ...
  for(int i=0; i<9; i++){
    ...
    f_NewParam_data_up8->FixParameter(i,fit_result_data->Parameter(i));
    f_NewParam_data_dn8->FixParameter(i,fit_result_data->Parameter(i));
    f_NewParam_data_up9->FixParameter(i,fit_result_data->Parameter(i));
    f_NewParam_data_dn9->FixParameter(i,fit_result_data->Parameter(i));
    ...
    if(i==0){
      ...
      f_NewParam_data_up8->FixParameter(i,fit_result_data->Parameter(i) + err_pars_up_data[i]);
      f_NewParam_data_dn8->FixParameter(i,fit_result_data->Parameter(i) - err_pars_dn_data[i]);
    }
  }

  TCanvas* cupdndata = new TCanvas("cupdndata", "Functions varied up and down, data",10,10,700,700);
  gPad->SetTickx();
  gPad->SetTicky();
  ...
  f_NewParam_data_up7->SetLineColor(11);
  f_NewParam_data_up7->Draw("SAME");
  leg -> AddEntry(f_NewParam_data_up7,"Par. 7 up", "l");

  f_NewParam_data_dn7->SetLineColor(12);
  f_NewParam_data_dn7->Draw("SAME");
  leg -> AddEntry(f_NewParam_data_dn7,"Par. 7 down", "l");

  f_NewParam_data_up8->SetLineColor(40);
  f_NewParam_data_up8->Draw("SAME");
  leg -> AddEntry(f_NewParam_data_up8,"Par. 8 up", "l");

  f_NewParam_data_dn8->SetLineColor(42);
  f_NewParam_data_dn8->Draw("SAME");
  leg -> AddEntry(f_NewParam_data_dn8,"Par. 8 down", "l");
  ...
  sstr_data_signal  << "((" <<d_tr_data[0]<<"*[0]+" <<d_tr_data[1]<<"*[1]+" <<d_tr_data[2]<<"*[2]+" <<d_tr_data[3]<<"*[3]+" <<d_tr_data[4]<<"*[4]+" <<d_tr_data[5]<<"*[5]+" <<d_tr_data[6]<<"*[6]+" <<d_tr_data[7]<<"*[7]+" <<d_tr_data[8]<<"*[8]" << ")* TMath::Voigt(x-(""("<<  c_tr_data[0] << "*[0]+" <<  c_tr_data[1] << "*[1]+"<<  c_tr_data[2] << "*[2]+"<<  c_tr_data[3] << "*[3]+"<<  c_tr_data[4] << "*[4]+"<<  c_tr_data[5] << "*[5]+"<<  c_tr_data[6] << "*[6]+"<<  c_tr_data[7] << "*[7]+"<<  c_tr_data[8] << "*[8]"<<")+("<< e_tr_data[0] << "*[0]+" <<  e_tr_data[1] << "*[1]+"<<  e_tr_data[2] << "*[2]+"<<  e_tr_data[3] << "*[3]+"<<  e_tr_data[4] << "*[4]+"<<  e_tr_data[5] << "*[5]+"<<  e_tr_data[6] << "*[6]+"<<  e_tr_data[7] << "*[7]+"<<  e_tr_data[8] << "*[8]" <<")*x),("<<"("<<  a_tr_data[0] << "*[0]+" <<  a_tr_data[1] << "*[1]+"<<  a_tr_data[2] << "*[2]+"<<  a_tr_data[3] << "*[3]+"<<  a_tr_data[4] << "*[4]+"<<  a_tr_data[5] << "*[5]+"<<  a_tr_data[6] << "*[6]+"<<  a_tr_data[7] << "*[7]+"<<  a_tr_data[8] << "*[8]" <<")+("<< f_tr_data[0] << "*[0]+" <<  f_tr_data[1] << "*[1]+"<<  f_tr_data[2] << "*[2]+"<<  f_tr_data[3] << "*[3]+"<<  f_tr_data[4] << "*[4]+"<<  f_tr_data[5] << "*[5]+"<<  f_tr_data[6] << "*[6]+"<<  f_tr_data[7] << "*[7]+"<<  f_tr_data[8] << "*[8]" <<")*x),("<<  b_tr_data[0] << "*[0]+" <<  b_tr_data[1] << "*[1]+"<<  b_tr_data[2] << "*[2]+"<<  b_tr_data[3] << "*[3]+"<<  b_tr_data[4] << "*[4]+"<<  b_tr_data[5] << "*[5]+"<<  b_tr_data[6] << "*[6]+"<<  b_tr_data[7] << "*[7]+"<<  b_tr_data[8] << "*[8]" <<"),4"<<"))";
  ...
  const char * c_formula_data_signal = s_formula_data_signal.c_str();
   ...
   //Integrate over all up and down variation itself
   //Par1
   TF1 *data_Eff_NewPar_up1_f =new TF1("data_Eff_NewPar_up1_f",c_formula_data_signal, 40,180);
   for(int i=0;i<9;i++)data_Eff_NewPar_up1_f->SetParameter(i, f_NewParam_data_up1->GetParameter(i));
   Double_t num_data_NewPar_up1_before = data_Eff_NewPar_up1_f->Integral(40,180,TMath::Power(10,-8)) / 2;
   cout<<"data number for ParUp1 before tagger:   "<< num_data_NewPar_up1_before <<endl;

   TF1 *data_Eff_NewPar_down1_f =new TF1("data_Eff_NewPar_down1_f",c_formula_data_signal, 40,180);
   for(int i=0;i<9;i++)data_Eff_NewPar_down1_f->SetParameter(i, f_NewParam_data_dn1->GetParameter(i));
   Double_t num_data_NewPar_down1_before = data_Eff_NewPar_down1_f->Integral(40,180,TMath::Power(10,-8)) / 2;
   cout<<"data number for ParDown1 before tagger:   "<< num_data_NewPar_down1_before <<endl;

   //Par2
   TF1 *data_Eff_NewPar_up2_f =new TF1("data_Eff_NewPar_up2_f",c_formula_data_signal, 40,180);
   for(int i=0;i<9;i++)data_Eff_NewPar_up2_f->SetParameter(i, f_NewParam_data_up2->GetParameter(i));
   Double_t num_data_NewPar_up2_before = data_Eff_NewPar_up2_f->Integral(40,180,TMath::Power(10,-8)) / 2;
   cout<<"data number for ParUp2 before tagger:   "<< num_data_NewPar_up2_before <<endl;

   TF1 *data_Eff_NewPar_down2_f =new TF1("data_Eff_NewPar_down2_f",c_formula_data_signal, 40,180);
   for(int i=0;i<9;i++)data_Eff_NewPar_down2_f->SetParameter(i, f_NewParam_data_dn2->GetParameter(i));
   Double_t num_data_NewPar_down2_before = data_Eff_NewPar_down2_f->Integral(40,180,TMath::Power(10,-8)) / 2;
   cout<<"data number for ParDown2 before tagger:   "<< num_data_NewPar_down2_before <<endl;

  //Par3
  TF1 *data_Eff_NewPar_up3_f =new TF1("data_Eff_NewPar_up3_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_up3_f->SetParameter(i, f_NewParam_data_up3->GetParameter(i));
  Double_t num_data_NewPar_up3_before = data_Eff_NewPar_up3_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParUp3 before tagger:   "<< num_data_NewPar_up3_before <<endl;

  TF1 *data_Eff_NewPar_down3_f =new TF1("data_Eff_NewPar_down3_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_down3_f->SetParameter(i, f_NewParam_data_dn3->GetParameter(i));
  Double_t num_data_NewPar_down3_before = data_Eff_NewPar_down3_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParDown3 before tagger:   "<< num_data_NewPar_down3_before <<endl;

  //Par4
  TF1 *data_Eff_NewPar_up4_f =new TF1("data_Eff_NewPar_up4_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_up4_f->SetParameter(i, f_NewParam_data_up4->GetParameter(i));
  Double_t num_data_NewPar_up4_before = data_Eff_NewPar_up4_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParUp4 before tagger:   "<< num_data_NewPar_up4_before <<endl;

  TF1 *data_Eff_NewPar_down4_f =new TF1("data_Eff_NewPar_down4_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_down4_f->SetParameter(i, f_NewParam_data_dn4->GetParameter(i));
  Double_t num_data_NewPar_down4_before = data_Eff_NewPar_down4_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParDown4 before tagger:   "<< num_data_NewPar_down4_before <<endl;

  //Par5
  TF1 *data_Eff_NewPar_up5_f =new TF1("data_Eff_NewPar_up5_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_up5_f->SetParameter(i, f_NewParam_data_up5->GetParameter(i));
  Double_t num_data_NewPar_up5_before = data_Eff_NewPar_up5_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParUp5 before tagger:   "<< num_data_NewPar_up5_before <<endl;

  TF1 *data_Eff_NewPar_down5_f =new TF1("data_Eff_NewPar_down5_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_down5_f->SetParameter(i, f_NewParam_data_dn5->GetParameter(i));
  Double_t num_data_NewPar_down5_before = data_Eff_NewPar_down5_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParDown5 before tagger:   "<< num_data_NewPar_down5_before <<endl;

  //Par6
  TF1 *data_Eff_NewPar_up6_f =new TF1("data_Eff_NewPar_up6_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_up6_f->SetParameter(i, f_NewParam_data_up6->GetParameter(i));
  Double_t num_data_NewPar_up6_before = data_Eff_NewPar_up6_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParUp6 before tagger:   "<< num_data_NewPar_up6_before <<endl;

  TF1 *data_Eff_NewPar_down6_f =new TF1("data_Eff_NewPar_down6_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_down6_f->SetParameter(i, f_NewParam_data_dn6->GetParameter(i));
  Double_t num_data_NewPar_down6_before = data_Eff_NewPar_down6_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParDown6 before tagger:   "<< num_data_NewPar_down6_before <<endl;

 //Par7
  TF1 *data_Eff_NewPar_up7_f =new TF1("data_Eff_NewPar_up7_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_up7_f->SetParameter(i, f_NewParam_data_up7->GetParameter(i));
  Double_t num_data_NewPar_up7_before = data_Eff_NewPar_up7_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParUp7 before tagger:   "<< num_data_NewPar_up7_before <<endl;

  TF1 *data_Eff_NewPar_down7_f =new TF1("data_Eff_NewPar_down7_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_down7_f->SetParameter(i, f_NewParam_data_dn7->GetParameter(i));
  Double_t num_data_NewPar_down7_before = data_Eff_NewPar_down7_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParDown7 before tagger:   "<< num_data_NewPar_down7_before <<endl;

 //Par8
  TF1 *data_Eff_NewPar_up8_f =new TF1("data_Eff_NewPar_up8_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_up8_f->SetParameter(i, f_NewParam_data_up8->GetParameter(i));
  Double_t num_data_NewPar_up8_before = data_Eff_NewPar_up8_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParUp8 before tagger:   "<< num_data_NewPar_up8_before <<endl;

  TF1 *data_Eff_NewPar_down8_f =new TF1("data_Eff_NewPar_down8_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_down8_f->SetParameter(i, f_NewParam_data_dn8->GetParameter(i));
  Double_t num_data_NewPar_down8_before = data_Eff_NewPar_down8_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParDown8 before tagger:   "<< num_data_NewPar_down8_before <<endl;

 //Par9
  TF1 *data_Eff_NewPar_up9_f =new TF1("data_Eff_NewPar_up9_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_up9_f->SetParameter(i, f_NewParam_data_up9->GetParameter(i));
  Double_t num_data_NewPar_up9_before = data_Eff_NewPar_up9_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParUp9 before tagger:   "<< num_data_NewPar_up9_before <<endl;

  TF1 *data_Eff_NewPar_down9_f =new TF1("data_Eff_NewPar_down9_f",c_formula_data_signal, 40,180);
  for(int i=0;i<9;i++)data_Eff_NewPar_down9_f->SetParameter(i, f_NewParam_data_dn9->GetParameter(i));
  Double_t num_data_NewPar_down9_before = data_Eff_NewPar_down9_f->Integral(40,180,TMath::Power(10,-8)) / 2;
  cout<<"data number for ParDown9 before tagger:   "<< num_data_NewPar_down9_before <<endl;
  ...
  if(num_data_NewPar_up8_before>num_data_before) {par8_up=num_data_NewPar_up8_before;par8_down=num_data_NewPar_down8_before;}
  else {par8_down=num_data_NewPar_up8_before;par8_up=num_data_NewPar_down8_before;}

  if(num_data_NewPar_up9_before>num_data_before) {par9_up=num_data_NewPar_up9_before;par9_down=num_data_NewPar_down9_before;}
  else {par9_down=num_data_NewPar_up9_before;par9_up=num_data_NewPar_down9_before;}

  all_up= TMath::Power(par1_up-num_data_before,2)+TMath::Power(par2_up-num_data_before,2)+TMath::Power(par3_up-num_data_before,2)+TMath::Power(par4_up-num_data_before,2)+TMath::Power(par5_up-num_data_before,2)+TMath::Power(par6_up-num_data_before,2)+TMath::Power(par7_up-num_data_before,2)+TMath::Power(par8_up-num_data_before,2);
  all_down= TMath::Power(par1_down-num_data_before,2)+TMath::Power(par2_down-num_data_before,2)+TMath::Power(par3_down-num_data_before,2)+TMath::Power(par4_down-num_data_before,2)+TMath::Power(par5_down-num_data_before,2)+TMath::Power(par6_down-num_data_before,2)+TMath::Power(par7_down-num_data_before,2)+TMath::Power(par8_down-num_data_before,2);
  ...
  myfile << "Parameter 8 Upvariation "<< par8_up-num_data_before<<endl;
  myfile << "Parameter 8 Downvariation "<< par8_down-num_data_before<<endl;
  myfile << "Parameter 9 Upvariation "<< par9_up-num_data_before<<endl;
  myfile << "Parameter 9 Downvariation "<< par9_down-num_data_before<<endl;
  myfile << "----------------------------------------------------------------------------------------------------------"<<endl;
  myfile << "all up variations quadraticly added: "<<TMath::Sqrt(all_up)<<endl;
  myfile << "all down variations quadraticly added: -"<<TMath::Sqrt(all_down)<<endl;
 ...
 //integrate over each variation and save the difference to normal number of bkg events in data before tagger
  ...
  sstr_data_bkg <<"("<< "(" <<g_tr_data[0]<<"*[0]+" <<g_tr_data[1]<<"*[1]+" <<g_tr_data[2]<<"*[2]+" <<g_tr_data[3]<<"*[3]+" <<g_tr_data[4]<<"*[4]+" <<g_tr_data[5]<<"*[5]+" <<g_tr_data[6]<<"*[6]+" <<g_tr_data[7]<<"*[7]+" <<g_tr_data[8]<<"*[8]" << ")*(1.-TMath::Power(1+TMath::Exp(-(x-("<<  h_tr_data[0] << "*[0]+" <<  h_tr_data[1] << "*[1]+"<<  h_tr_data[2] << "*[2]+"<<  h_tr_data[3] << "*[3]+"<<  h_tr_data[4] << "*[4]+"<<  h_tr_data[5] << "*[5]+"<<  h_tr_data[6] << "*[6]+"<<  h_tr_data[7] << "*[7]+"<<  h_tr_data[8]  <<"))/("<<  i_tr_data[0] << "*[0]+" <<  i_tr_data[1] << "*[1]+"<<  i_tr_data[2] << "*[2]+"<<  i_tr_data[3] << "*[3]+"<<  i_tr_data[4] << "*[4]+"<<  i_tr_data[5] << "*[5]+"<<  i_tr_data[6] << "*[6]+"<<  i_tr_data[7] << "*[7]+"<<  i_tr_data[8] <<")),-1))" <<")";
  ...
  //Integrate over all up and down variation itself
  //Par1
  TF1 *data_bkg_Eff_NewPar_up1_f =new TF1("data_bkg_Eff_NewPar_up1_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_up1_f->SetParameter(i, f_NewParam_data_up1->GetParameter(i));
  Double_t num_data_bkg_NewPar_up1_before = data_bkg_Eff_NewPar_up1_f->Integral(40,180) / 2;
  cout<<"data number for ParUp1 before tagger:   "<< num_data_bkg_NewPar_up1_before <<endl;

  TF1 *data_bkg_Eff_NewPar_down1_f =new TF1("data_bkg_Eff_NewPar_down1_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_down1_f->SetParameter(i, f_NewParam_data_dn1->GetParameter(i));
  Double_t num_data_bkg_NewPar_down1_before = data_bkg_Eff_NewPar_down1_f->Integral(40,180) / 2;
  cout<<"data number for ParDown1 before tagger:   "<< num_data_bkg_NewPar_down1_before <<endl;

  //Par2
  TF1 *data_bkg_Eff_NewPar_up2_f =new TF1("data_bkg_Eff_NewPar_up2_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_up2_f->SetParameter(i, f_NewParam_data_up2->GetParameter(i));
  Double_t num_data_bkg_NewPar_up2_before = data_bkg_Eff_NewPar_up2_f->Integral(40,180) / 2;
  cout<<"data number for ParUp2 before tagger:   "<< num_data_bkg_NewPar_up2_before <<endl;

  TF1 *data_bkg_Eff_NewPar_down2_f =new TF1("data_bkg_Eff_NewPar_down2_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_down2_f->SetParameter(i, f_NewParam_data_dn2->GetParameter(i));
  Double_t num_data_bkg_NewPar_down2_before = data_bkg_Eff_NewPar_down2_f->Integral(40,180) / 2;
  cout<<"data number for ParDown2 before tagger:   "<< num_data_bkg_NewPar_down2_before <<endl;

  //Par3
  TF1 *data_bkg_Eff_NewPar_up3_f =new TF1("data_bkg_Eff_NewPar_up3_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_up3_f->SetParameter(i, f_NewParam_data_up3->GetParameter(i));
  Double_t num_data_bkg_NewPar_up3_before = data_bkg_Eff_NewPar_up3_f->Integral(40,180) / 2;
  cout<<"data number for ParUp3 before tagger:   "<< num_data_bkg_NewPar_up3_before <<endl;

  TF1 *data_bkg_Eff_NewPar_down3_f =new TF1("data_bkg_Eff_NewPar_down3_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_down3_f->SetParameter(i, f_NewParam_data_dn3->GetParameter(i));
  Double_t num_data_bkg_NewPar_down3_before = data_bkg_Eff_NewPar_down3_f->Integral(40,180) / 2;
  cout<<"data number for ParDown3 before tagger:   "<< num_data_bkg_NewPar_down3_before <<endl;

  //Par4
  TF1 *data_bkg_Eff_NewPar_up4_f =new TF1("data_bkg_Eff_NewPar_up4_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_up4_f->SetParameter(i, f_NewParam_data_up4->GetParameter(i));
  Double_t num_data_bkg_NewPar_up4_before = data_bkg_Eff_NewPar_up4_f->Integral(40,180) / 2;
  cout<<"data number for ParUp4 before tagger:   "<< num_data_bkg_NewPar_up4_before <<endl;

  TF1 *data_bkg_Eff_NewPar_down4_f =new TF1("data_bkg_Eff_NewPar_down4_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_down4_f->SetParameter(i, f_NewParam_data_dn4->GetParameter(i));
  Double_t num_data_bkg_NewPar_down4_before = data_bkg_Eff_NewPar_down4_f->Integral(40,180) / 2;
  cout<<"data number for ParDown4 before tagger:   "<< num_data_bkg_NewPar_down4_before <<endl;

  //Par5
  TF1 *data_bkg_Eff_NewPar_up5_f =new TF1("data_bkg_Eff_NewPar_up5_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_up5_f->SetParameter(i, f_NewParam_data_up5->GetParameter(i));
  Double_t num_data_bkg_NewPar_up5_before = data_bkg_Eff_NewPar_up5_f->Integral(40,180) / 2;
  cout<<"data number for ParUp5 before tagger:   "<< num_data_bkg_NewPar_up5_before <<endl;

  TF1 *data_bkg_Eff_NewPar_down5_f =new TF1("data_bkg_Eff_NewPar_down5_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_down5_f->SetParameter(i, f_NewParam_data_dn5->GetParameter(i));
  Double_t num_data_bkg_NewPar_down5_before = data_bkg_Eff_NewPar_down5_f->Integral(40,180) / 2;
  cout<<"data number for ParDown5 before tagger:   "<< num_data_bkg_NewPar_down5_before <<endl;

  //Par6
  TF1 *data_bkg_Eff_NewPar_up6_f =new TF1("data_bkg_Eff_NewPar_up6_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_up6_f->SetParameter(i, f_NewParam_data_up6->GetParameter(i));
  Double_t num_data_bkg_NewPar_up6_before = data_bkg_Eff_NewPar_up6_f->Integral(40,180) / 2;
  cout<<"data number for ParUp6 before tagger:   "<< num_data_bkg_NewPar_up6_before <<endl;

  TF1 *data_bkg_Eff_NewPar_down6_f =new TF1("data_bkg_Eff_NewPar_down6_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_down6_f->SetParameter(i, f_NewParam_data_dn6->GetParameter(i));
  Double_t num_data_bkg_NewPar_down6_before = data_bkg_Eff_NewPar_down6_f->Integral(40,180) / 2;
  cout<<"data number for ParDown6 before tagger:   "<< num_data_bkg_NewPar_down6_before <<endl;

 //Par7
  TF1 *data_bkg_Eff_NewPar_up7_f =new TF1("data_bkg_Eff_NewPar_up7_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_up7_f->SetParameter(i, f_NewParam_data_up7->GetParameter(i));
  Double_t num_data_bkg_NewPar_up7_before = data_bkg_Eff_NewPar_up7_f->Integral(40,180) / 2;
  cout<<"data number for ParUp7 before tagger:   "<< num_data_bkg_NewPar_up7_before <<endl;

  TF1 *data_bkg_Eff_NewPar_down7_f =new TF1("data_bkg_Eff_NewPar_down7_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_down7_f->SetParameter(i, f_NewParam_data_dn7->GetParameter(i));
  Double_t num_data_bkg_NewPar_down7_before = data_bkg_Eff_NewPar_down7_f->Integral(40,180) / 2;
  cout<<"data number for ParDown7 before tagger:   "<< num_data_bkg_NewPar_down7_before <<endl;

  //Par8
  TF1 *data_bkg_Eff_NewPar_up8_f =new TF1("data_bkg_Eff_NewPar_up8_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_up8_f->SetParameter(i, f_NewParam_data_up8->GetParameter(i));
  Double_t num_data_bkg_NewPar_up8_before = data_bkg_Eff_NewPar_up8_f->Integral(40,180) / 2;
  cout<<"data number for ParUp8 before tagger:   "<< num_data_bkg_NewPar_up8_before <<endl;

  TF1 *data_bkg_Eff_NewPar_down8_f =new TF1("data_bkg_Eff_NewPar_down8_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_down8_f->SetParameter(i, f_NewParam_data_dn8->GetParameter(i));
  Double_t num_data_bkg_NewPar_down8_before = data_bkg_Eff_NewPar_down8_f->Integral(40,180) / 2;
  cout<<"data number for ParDown8 before tagger:   "<< num_data_bkg_NewPar_down8_before <<endl;
 
  //Par9
  TF1 *data_bkg_Eff_NewPar_up9_f =new TF1("data_bkg_Eff_NewPar_up9_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_up9_f->SetParameter(i, f_NewParam_data_up9->GetParameter(i));
  Double_t num_data_bkg_NewPar_up9_before = data_bkg_Eff_NewPar_up9_f->Integral(40,180) / 2;
  cout<<"data number for ParUp9 before tagger:   "<< num_data_bkg_NewPar_up9_before <<endl;

  TF1 *data_bkg_Eff_NewPar_down9_f =new TF1("data_bkg_Eff_NewPar_down9_f",c_formula_data_bkg, 40,180);
  for(int i=0;i<9;i++)data_bkg_Eff_NewPar_down9_f->SetParameter(i, f_NewParam_data_dn9->GetParameter(i));
  Double_t num_data_bkg_NewPar_down9_before = data_bkg_Eff_NewPar_down9_f->Integral(40,180) / 2;
  cout<<"data number for ParDown9 before tagger:   "<< num_data_bkg_NewPar_down9_before <<endl;
  ...
  if(num_data_bkg_NewPar_up8_before>number_back_data_miss) {par8_up=num_data_bkg_NewPar_up8_before;par8_down=num_data_bkg_NewPar_down8_before;}
  else {par8_down=num_data_bkg_NewPar_up8_before;par8_up=num_data_bkg_NewPar_down8_before;}

  if(num_data_bkg_NewPar_up9_before>number_back_data_miss) {par9_up=num_data_bkg_NewPar_up9_before;par9_down=num_data_bkg_NewPar_down9_before;}
  else {par9_down=num_data_bkg_NewPar_up9_before;par9_up=num_data_bkg_NewPar_down9_before;}

  all_up= TMath::Power(par1_up-number_back_data_miss,2)+TMath::Power(par2_up-number_back_data_miss,2)+TMath::Power(par3_up-number_back_data_miss,2)+TMath::Power(par4_up-number_back_data_miss,2)+TMath::Power(par5_up-number_back_data_miss,2)+TMath::Power(par6_up-number_back_data_miss,2)+TMath::Power(par7_up-number_back_data_miss,2)+TMath::Power(par8_up-number_back_data_miss,2);
  all_down= TMath::Power(par1_down-number_back_data_miss,2)+TMath::Power(par2_down-number_back_data_miss,2)+TMath::Power(par3_down-number_back_data_miss,2)+TMath::Power(par4_down-number_back_data_miss,2)+TMath::Power(par5_down-number_back_data_miss,2)+TMath::Power(par6_down-number_back_data_miss,2)+TMath::Power(par7_down-number_back_data_miss,2)+TMath::Power(par8_down-number_back_data_miss,2);
  ...
  myfile << "Parameter 7 Upvariation "<< par8_up-number_back_data_miss<<endl;
  myfile << "Parameter 7 Downvariation "<< par8_down-number_back_data_miss<<endl;
  myfile << "Parameter 7 Upvariation "<< par9_up-number_back_data_miss<<endl;
  myfile << "Parameter 7 Downvariation "<< par9_down-number_back_data_miss<<endl;
  myfile << "----------------------------------------------------------------------------------------------------------"<<endl;
  myfile << "all up variations quadraticly added: "<<TMath::Sqrt(all_up)<<endl;
  myfile << "all down variations quadraticly added: -"<<TMath::Sqrt(all_down)<<endl;
  ...
  cout<<"sf_eff_err_up  "<<sf_eff_err_up<<endl;
  cout<<"sf_eff_err_down  "<<sf_eff_err_down<<"  =  "<< TMath::Power((1/(num_MC_after/num_MC_before)) * error_data_down/(num_data_after/num_data_before),2) <<"  +  "<<TMath::Power(sf_eff/(num_MC_after/num_MC_before) *  error_MC_down/(num_MC_after/num_MC_before)  ,2)  <<endl;
  cout<<"1. Teil "<<1/(num_MC_after/num_MC_before) <<" *  "<< error_data_down/(num_data_after/num_data_before)<<endl;


  myfile.close();

  //Fits with different matching parameter
 // -------------------
  //Background Fit
  // -------------------
  TCanvas *background_c1 = new TCanvas("background_c1","background fit",10,10,700,700);
  gPad->SetTickx();
  gPad->SetTicky();
  background_c1->Clear();
  background_c1->cd();
  ...
  TTbar_unmatched_dr12->SetXTitle("M_{W}^{rec} [GeV]");
  TTbar_unmatched_dr12->SetYTitle("Events");
  TTbar_unmatched_dr12->SetTitleSize(0.045);
  TTbar_unmatched_dr12->GetYaxis()->SetTitleSize(0.045);
  TTbar_unmatched_dr12->GetYaxis()->SetTitleOffset(1.1);
  TTbar_unmatched_dr12->SetTitle("");
  TTbar_unmatched_dr12->SetMarkerStyle(20);
  TTbar_unmatched_dr12->SetMarkerSize(1.);
  TTbar_unmatched_dr12->SetLineColor(kBlue+1);
  TTbar_unmatched_dr12->SetMarkerColor(kBlue+1);
  TTbar_unmatched_dr12->GetYaxis()->SetRangeUser(0, 800);
  TTbar_unmatched_dr12->Draw("E1");


  TH1D* back_dr12 = (TH1D*)TTbar_unmatched_dr12->Clone();
  back_dr12->Add(other);
  back_dr12->Add(WJets);
  back_dr12->Add(QCD);
  ...
  back_dr12->Draw("PZ");
  back_dr12->Fit(background_fit, "R");
  background_fit->DrawClone("same");
  ...
  info = "unmatched t#bar{t} events";
  info2 = "40 GeV < m_{W} < 180 GeV";
  info3 = "bkg(x) = p0*(1-1/(1+e^{-x'}))";
  info4 = "x' = (x-p1)/p2";
  info4 = "(matching parameter 1.2)";
  text = new TLatex();
  text->SetTextFont(62);
  text->SetNDC();
  text->SetTextColor(kBlue+1);
  ...
  background_c1->Print(folder +"dr12_background_fit.eps");
  
  // -------------------
  // Signal fit
  // -------------------
  
  TCanvas *signal_c1 = new TCanvas("signal_c1","signal fit",10,10,700,700);
  gPad->SetTickx();
  gPad->SetTicky();
  signal_c1->Clear();
  signal_c1->cd();
  TTbar_matched_dr04->SetXTitle("M_{W}^{rec} [GeV]");
  TTbar_matched_dr04->SetYTitle("Events");
  TTbar_matched_dr04->SetTitleSize(0.045);
  TTbar_matched_dr04->GetYaxis()->SetTitleSize(0.045);
  TTbar_matched_dr04->GetYaxis()->SetTitleOffset(1.1);
  TTbar_matched_dr04->SetTitle("");
  TTbar_matched_dr04->SetMarkerStyle(24);
  TTbar_matched_dr04->SetMarkerSize(1.);
  TTbar_matched_dr04->SetLineColor(kRed);
  TTbar_matched_dr04->SetMarkerColor(kRed);
  TTbar_matched_dr04 ->GetYaxis()->SetRangeUser(0, 550);
  TTbar_matched_dr04->Draw("PZ");
  ...
  TTbar_matched_dr04->Fit(signal_fit,"R");
  signal_fit->DrawClone("same");
  ...
  signal_c1->Print(folder +"dr04_signal_fit.eps");
