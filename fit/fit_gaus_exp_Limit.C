...
void fit_gaus_exp_Limit()
{
  ...
  TString hist_name = "tagger_zwtag/reco_mass_W";
  ...
  TString folder ="gaus_exp/AFTER_";
  // -------------------
  //Background Fit
  // -------------------
  ...
  background_c->Print(folder +"Limit_background_fit.eps");
  ...
  signal_c->Print(folder +"Limit_signal_fit.eps");
  ...
  //Set Limits of variation
  signal_background_fit->SetParLimits(3, background_fit->GetParameter(0) - background_fit->GetParError(0),background_fit->GetParameter(0) + background_fit->GetParError(0));
  signal_background_fit->SetParLimits(4, background_fit->GetParameter(1) - background_fit->GetParError(1),background_fit->GetParameter(1) + background_fit->GetParError(1));
  signal_background_fit->SetParLimits(5, background_fit->GetParameter(2) - background_fit->GetParError(2),background_fit->GetParameter(2) + background_fit->GetParError(2));
  signal_background_fit->SetParLimits(6, background_fit->GetParameter(3) - background_fit->GetParError(3),background_fit->GetParameter(3) + background_fit->GetParError(3));
  signal_background_fit->SetParLimits(7, background_fit->GetParameter(4) - background_fit->GetParError(4),background_fit->GetParameter(4) + background_fit->GetParError(4));
  ...
  signal_background_c->Print(folder +"Limit_signal_background_fit.eps");
  // ------------------------
  //        Data
  // ------------------------
  ...
  //background
  data_fit->SetParameter(3, sc*background_fit->GetParameter(3));   
  data_fit->SetParameter(4, sc*background_fit->GetParameter(4));
  data_fit->SetParameter(5, sc*background_fit->GetParameter(5));
  data_fit->SetParameter(6, sc*background_fit->GetParameter(6));   
  data_fit->SetParameter(7, background_fit->GetParameter(7));

  //Set Limits of variation
  data_fit->SetParLimits(3, background_fit->GetParameter(0) - background_fit->GetParError(0),background_fit->GetParameter(0) + background_fit->GetParError(0));
  data_fit->SetParLimits(4, background_fit->GetParameter(1) - background_fit->GetParError(1),background_fit->GetParameter(1) + background_fit->GetParError(1));
  data_fit->SetParLimits(5, background_fit->GetParameter(2) - background_fit->GetParError(2),background_fit->GetParameter(2) + background_fit->GetParError(2));
  data_fit->SetParLimits(6, background_fit->GetParameter(3) - background_fit->GetParError(3),background_fit->GetParameter(3) + background_fit->GetParError(3));
  data_fit->SetParLimits(7, background_fit->GetParameter(4) - background_fit->GetParError(4),background_fit->GetParameter(4) + background_fit->GetParError(4));
  ...
  bc->SetLineStyle(kDashed);
  bc->DrawClone("same");
  data_c->Print(folder +"Limit_data_fit.eps");
  ...
  ofstream myfile;
  myfile.open (folder+"numbers_Limit.txt");
