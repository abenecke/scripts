...
void ThetaNamesTPrime900ZT()
{

  const int nproc=7;

  TString process[nproc] = {"TTbar", "WJets","QCD","ST","DYJetsToLL","MC_ZPrime1500ToTPrime900T_TPrimeToZT","MC_ZPrime2000ToTPrime900T_TPrimeToZT"};
