...
void ThetaNamesTPrime900HT()
{

  const int nproc=7;

  TString process[nproc] = {"TTbar", "WJets","QCD","ST","DYJetsToLL","MC_ZPrime1500ToTPrime900T_TPrimeToHT","MC_ZPrime2000ToTPrime900T_TPrimeToHT"};
