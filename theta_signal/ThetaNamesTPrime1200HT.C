...
void ThetaNamesTPrime1200HT()
{
  ...
  TString process[nproc] = {"TTbar", "WJets","QCD","ST","DYJetsToLL","MC_ZPrime1500ToTPrime1200T_TPrimeToHT","MC_ZPrime2000ToTPrime1200T_TPrimeToHT","MC_ZPrime2500ToTPrime1500T_TPrimeToHT"};
