...
void ThetaNamesTPrime1200HT()
{
  ...
  for(int j=0; j<Nsyst; ++j){
    TString directory = "/nfs/dust/cms/user/abenecke/ZPrimeTotTPrime/CMSSW_8X/rootfiles/uncertainties/muon/none";
    ...
    for(int i=0; i<nmax; ++i){
      ...
      Double_t higgsnotop[29]={600, 780, 840, 900, 960, 1020, 1080, 1140, 1200, 1260, 1320, 1380, 1440, 1500, 1560, 1620, 1680, 1740, 1800, 1860, 1920, 1980, 2040, 2100,  2220, 2340, 2460, 2580,   2940};
      TH1F* M_higgsnotop =  (TH1F*) M_higgsnotop_old->Rebin(28,"M_higgsnotop",higgsnotop);
      ...
      Double_t zwtop[35]={600, 960, 1020, 1080, 1140, 1200, 1260, 1320, 1380, 1440, 1500, 1560, 1620, 1680, 1740, 1800, 1860, 1920, 1980, 2040, 2100, 2160, 2220, 2280, 2340, 2400, 2460, 2520, 2580, 2640, 2700, 2760, 2820, 2880, 2940};
      TH1F* M_zwtop =  (TH1F*) M_zwtop_old ->Rebin(34,"M_zwtop",zwtop);
...
Double_t zwnotop[36]={600, 660, 720, 780, 840, 900, 960, 1020, 1080, 1140, 1200, 1260, 1320, 1380, 1440, 1500, 1560, 1620, 1680, 1740, 1800, 1860, 1920, 1980, 2040, 2100, 2160, 2220, 2280, 2340, 2400, 2460, 2580, 2700,  2820, 2940};
      ...
      //  Double_t higgtop_one_btag[2]={600,  2940};//elec

      Double_t higgtop_one_btag[27]={600, 1020, 1080, 1140, 1200, 1260, 1320, 1380, 1440, 1500, 1560, 1620, 1680, 1740, 1800, 1860, 1920, 1980, 2040, 2100, 2160, 2280, 2340, 2460,  2580,  2700,  2940};//chi2cu
      TH1F* M_higgstop_one_btag =  (TH1F*) M_higgstop_one_btag_old->Rebin(26,"M_higgstop_one_btag",higgtop_one_btag);
