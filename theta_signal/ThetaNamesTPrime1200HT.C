...
void ThetaNamesTPrime1200HT()
{
  ...
  for(int j=0; j<Nsyst; ++j){
    TString directory = "/nfs/dust/cms/user/abenecke/ZPrimeTotTPrime/25ns/rootfile/muonpt/50";
    ...
    TString outfilename = "/nfs/dust/cms/user/abenecke/ZPrimeTotTPrime/25ns/rootfile/muonpt/50/theta_histograms_MZPrime";
    if(systname[j]!="default"){
