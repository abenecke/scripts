...
void ThetaNamesTPrime1500ZT()
{

  const int nproc=7;

  TString process[nproc] = {"TTbar", "WJets","QCD","ST","DYJetsToLL","MC_ZPrime2000ToTPrime1500T_TPrimeToZT","MC_ZPrime2500ToTPrime1500T_TPrimeToZT"};
  ...
  for(int j=0; j<Nsyst; ++j){
     ...
     TH1F* M_higgsnotop =  (TH1F*) M_higgsnotop_old->Rebin(30,"M_higgsnotop",higgsnotop);
       ////////////////////////////////////////////////////////////////////////////////////////
       TH1F* M_zwtop = (TH1F*)infile->Get("zw_top_chi2min_chi2cut/M_ZPrime_rec");
