...
void ThetaNamesTPrime1200ZT()
{
  const bool top=false;
  const bool notop=true;
  const int nproc=8;

  TString process[nproc] = {"TTbar", "WJets","QCD","ST","DYJetsToLL","MC_ZPrime1500ToTPrime1200T_TPrimeToZT","MC_ZPrime2000ToTPrime1200T_TPrimeToZT","MC_ZPrime2500ToTPrime1200T_TPrimeToZT"};
